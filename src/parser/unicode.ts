...
function lookupInUnicodeMap(code: CharCode, map: CharCode[]): boolean {
 ...
 * @returns 如果是则返回 true，否则返回 false。
 */
export function isIdentifierStart(ch: CharCode, useES3Identifier?: boolean): boolean {
 ...
 * @returns 如果是则返回 true，否则返回 false。
 */
export function isIdentifierPart(ch: CharCode, useES3Identifier?: boolean): boolean {
    return ch >= CharCode.a && ch <= CharCode.z ||
        ch >= CharCode.A && ch <= CharCode.Z ||
