 ...
 * @returns 如果是则返回 true，否则返回 false。
 */
export function isIdentifierStart(ch: CharCode) {
    return ch >= CharCode.a && ch <= CharCode.z ||
        ch >= CharCode.A && ch <= CharCode.Z ||
        ch === CharCode.underline || ch === CharCode.dollar ||
        ch >= CharCode.MAX_ASCII && lookupInUnicodeMap(ch, unicodeES5IdentifierStart);
}
 ...
 * @returns 如果是则返回 true，否则返回 false。
 */
export function isIdentifierPart(ch: CharCode) {
    return ch >= CharCode.a && ch <= CharCode.z ||
        ch >= CharCode.A && ch <= CharCode.Z ||
        ch >= CharCode.num0 && ch <= CharCode.num9 ||
        ch === CharCode.dollar || ch === CharCode.underline ||
        ch >= CharCode.MAX_ASCII && lookupInUnicodeMap(ch, unicodeES5IdentifierPart);
}
