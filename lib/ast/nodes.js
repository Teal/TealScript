 ...
 * 表示一个成员（如方法、字段、类等）定义。
 */
var MemberDeclaration = (function (_super) {
    __extends(MemberDeclaration, _super);
 ...
 * 表示一个扩展定义。
 */
var ExtensionDeclaration = (function (_super) {
    __extends(ExtensionDeclaration, _super);
     ...
     * @returns 返回访问器的处理结果。
     */
    ExtensionDeclaration.prototype.accept = function (vistior) {
     ...
     * @returns 如果遍历是因为 *callback* 返回 false 而中止，则返回 false，否则返回 true。
     */
    ExtensionDeclaration.prototype.each = function (callback, scope) {
...
var AccessorDeclaration = (function (_super) {
    ...
    Object.defineProperty(AccessorDeclaration.prototype, "get", {
        /**
         * 判断当前访问器是否是获取访问器。
         */
        get: function () { return !this.set; },
        enumerable: true,
        configurable: true
    });
    /**
