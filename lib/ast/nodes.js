...
var SourceFile = (function (_super) {
    ...
    SourceFile.prototype.each = function (callback, scope) {
        return (!this.comments || this.comments.each(callback, scope)) &&
            ...
            (!this.statements || this.statements.each(callback, scope));
    };
    return SourceFile;
}(Node));
...
var Statement = (function (_super) {
    ...
    /**
     * 获取错误语句。该语句可作为语法解析错误时的替代语句使用。
     */
    Statement.error = Object.freeze(new ErrorStatement());
    return Statement;
}(Node));
 ...
 * 表示一个错误语句。
 */
var ErrorStatement = (function (_super) {
    __extends(ErrorStatement, _super);
     ...
     * @returns 返回访问器的处理结果。
     */
    ErrorStatement.prototype.accept = function (vistior) { };
...
var BlockStatement = (function (_super) {
    ...
    BlockStatement.prototype.each = function (callback, scope) {
        return (!this.statements || this.statements.each(callback, scope));
    };
...
var VariableStatement = (function (_super) {
    ...
    VariableStatement.prototype.each = function (callback, scope) {
        return (!this.variables || this.variables.each(callback, scope));
    };
...
var SwitchStatement = (function (_super) {
    ...
    SwitchStatement.prototype.each = function (callback, scope) {
        return (!this.condition || callback.call(scope, this.condition, "condition", this) !== false) &&
            (!this.cases || this.cases.each(callback, scope));
    };
...
var CaseClause = (function (_super) {
    ...
    Object.defineProperty(CaseClause.prototype, "end", {
         ...
         * 获取当前节点的结束位置。
         */
        get: function () { return this.statements.length ? this.statements[this.statements.length - 1].end : this.colon; },
        enumerable: true,
        configurable: true
    });
    /**
...
var Declaration = (function (_super) {
    ...
    Object.defineProperty(Declaration.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
...
var ClassDeclaration = (function (_super) {
    ...
    Object.defineProperty(ClassDeclaration.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
...
var PropertyDeclaration = (function (_super) {
    ...
    Object.defineProperty(PropertyDeclaration.prototype, "end", {
         ...
         * 获取当前节点的结束位置。
         */
        get: function () { return this.value.end; },
        enumerable: true,
        configurable: true
    });
    /**
...
var AccessorDeclaration = (function (_super) {
    ...
    Object.defineProperty(AccessorDeclaration.prototype, "start", {
         ...
         * 获取当前节点的开始位置。
         */
        get: function () { return this.get != null ? this.get : this.set; },
        enumerable: true,
        configurable: true
    });
    /**
...
var NamespaceDeclaration = (function (_super) {
    ...
    NamespaceDeclaration.prototype.each = function (callback, scope) {
        return (!this.names || this.names.each(callback, scope)) &&
            (!this.members || this.members.each(callback, scope));
    };
...
var ImportDirective = (function (_super) {
    ...
    ImportDirective.prototype.each = function (callback, scope) {
        return (!this.elements || this.elements.each(callback, scope)) &&
...
var TemplateLiteral = (function (_super) {
    ...
    TemplateLiteral.prototype.each = function (callback, scope) {
        return (!this.spans || this.spans.each(callback, scope));
    };
 ...
 * 表示一个类型转换表达式(<T>xx)。
 */
var TypeCastExpression = (function (_super) {
    __extends(TypeCastExpression, _super);
     ...
     * @returns 返回访问器的处理结果。
     */
    TypeCastExpression.prototype.accept = function (vistior) {
     ...
     * @returns 如果遍历是因为 *callback* 返回 false 而中止，则返回 false，否则返回 true。
     */
    TypeCastExpression.prototype.each = function (callback, scope) {
...
var GenericTypeExpression = (function (_super) {
    ...
    GenericTypeExpression.prototype.each = function (callback, scope) {
        return callback.call(scope, this.element, "element", this) !== false &&
            (!this.genericArguments || this.genericArguments.each(callback, scope));
    };
...
var JsxElement = (function (_super) {
    ...
    JsxElement.prototype.each = function (callback, scope) {
        return callback.call(scope, this.tagName, "tagName", this) !== false &&
            (!this.attributes || this.attributes.each(callback, scope)) &&
            (!this.children || this.children.each(callback, scope));
    };
    return JsxElement;
}(JsxNode));
