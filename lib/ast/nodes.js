 ...
 * 表示一个正则表达式字面量(/.../)。
 */
var RegExpLiteral = (function (_super) {
    __extends(RegExpLiteral, _super);
     ...
     * @param vistior 要使用的节点访问器。
     */
    RegExpLiteral.prototype.accept = function (vistior) {
     ...
     * @returns 如果循环是因为 *callback* 返回 false 而中止，则返回 false，否则返回 true。
     */
    RegExpLiteral.prototype.each = function (callback, scope) {
 ...
 * 表示一个模板字符串字面量(`...`)。
 */
var TemplateStringLiteral = (function (_super) {
    __extends(TemplateStringLiteral, _super);
    function TemplateStringLiteral() {
        _super.apply(this, arguments);
    }
    /**
     * 使用指定的节点访问器处理当前节点。
     * @param vistior 要使用的节点访问器。
     */
    TemplateStringLiteral.prototype.accept = function (vistior) {
     ...
     * @returns 如果循环是因为 *callback* 返回 false 而中止，则返回 false，否则返回 true。
     */
    TemplateStringLiteral.prototype.each = function (callback, scope) {
