...
(function (ts) {
    ...
    var textToToken = {
        "abstract": ts.TokenType.abstract,
        "any": ts.TokenType.any,
        "as": ts.TokenType.as,
        "boolean": ts.TokenType.boolean,
        "break": ts.TokenType.break,
        "case": ts.TokenType.case,
        "catch": ts.TokenType.catch,
        "class": ts.TokenType.class,
        "continue": ts.TokenType.continue,
        "const": ts.TokenType.const,
        "constructor": ts.TokenType.constructor,
        "debugger": ts.TokenType.debugger,
        "declare": ts.TokenType.declare,
        "default": ts.TokenType.default,
        "delete": ts.TokenType.delete,
        "do": ts.TokenType.do,
        "else": ts.TokenType.else,
        "enum": ts.TokenType.enum,
        "export": ts.TokenType.export,
        "extends": ts.TokenType.extends,
        "false": ts.TokenType.false,
        "finally": ts.TokenType.finally,
        "for": ts.TokenType.for,
        "from": ts.TokenType.from,
        "function": ts.TokenType.function,
        "get": ts.TokenType.get,
        "if": ts.TokenType.if,
        "implements": ts.TokenType.implements,
        "import": ts.TokenType.import,
        "in": ts.TokenType.in,
        "instanceof": ts.TokenType.instanceOf,
        "interface": ts.TokenType.interface,
        "is": ts.TokenType.is,
        "let": ts.TokenType.let,
        "module": ts.TokenType.module,
        "namespace": ts.TokenType.namespace,
        "never": ts.TokenType.never,
        "new": ts.TokenType.new,
        "null": ts.TokenType.null,
        "number": ts.TokenType.number,
        "package": ts.TokenType.package,
        "private": ts.TokenType.private,
        "protected": ts.TokenType.protected,
        "public": ts.TokenType.public,
        "readonly": ts.TokenType.readonly,
        "require": ts.TokenType.require,
        "global": ts.TokenType.global,
        "return": ts.TokenType.return,
        "set": ts.TokenType.set,
        "static": ts.TokenType.static,
        "string": ts.TokenType.string,
        "super": ts.TokenType.super,
        "switch": ts.TokenType.switch,
        "symbol": ts.TokenType.symbol,
        "this": ts.TokenType.this,
        "throw": ts.TokenType.throw,
        "true": ts.TokenType.true,
        "try": ts.TokenType.try,
        "type": ts.TokenType.type,
        "typeof": ts.TokenType.typeOf,
        "undefined": ts.TokenType.undefined,
        "var": ts.TokenType.var,
        "void": ts.TokenType.void,
        "while": ts.TokenType.while,
        "with": ts.TokenType.with,
        "yield": ts.TokenType.yield,
        "async": ts.TokenType.async,
        "await": ts.TokenType.await,
        "of": ts.TokenType.of,
        "{": ts.TokenType.openBrace,
        "}": ts.TokenType.closeBrace,
        "(": ts.TokenType.openParen,
        ")": ts.TokenType.closeParen,
        "[": ts.TokenType.openBracket,
        "]": ts.TokenType.closeBracket,
        ".": ts.TokenType.dot,
        "...": ts.TokenType.dotDotDot,
        ";": ts.TokenType.semicolon,
        ",": ts.TokenType.comma,
        "<": ts.TokenType.lessThan,
        ">": ts.TokenType.greaterThan,
        "<=": ts.TokenType.lessThanEquals,
        ">=": ts.TokenType.greaterThanEquals,
        "==": ts.TokenType.equalsEquals,
        "!=": ts.TokenType.exclamationEquals,
        "===": ts.TokenType.equalsEqualsEquals,
        "!==": ts.TokenType.exclamationEqualsEquals,
        "=>": ts.TokenType.equalsGreaterThan,
        "+": ts.TokenType.plus,
        "-": ts.TokenType.minus,
        "**": ts.TokenType.asteriskAsterisk,
        "*": ts.TokenType.asterisk,
        "/": ts.TokenType.slash,
        "%": ts.TokenType.percent,
        "++": ts.TokenType.plusPlus,
        "--": ts.TokenType.minusMinus,
        "<<": ts.TokenType.lessThanLessThan,
        "</": ts.TokenType.lessThanSlash,
        ">>": ts.TokenType.greaterThanGreaterThan,
        ">>>": ts.TokenType.greaterThanGreaterThanGreaterThan,
        "&": ts.TokenType.ampersand,
        "|": ts.TokenType.bar,
        "^": ts.TokenType.caret,
        "!": ts.TokenType.exclamation,
        "~": ts.TokenType.tilde,
        "&&": ts.TokenType.ampersandAmpersand,
        "||": ts.TokenType.barBar,
        "?": ts.TokenType.question,
        ":": ts.TokenType.colon,
        "=": ts.TokenType.equals,
        "+=": ts.TokenType.plusEquals,
        "-=": ts.TokenType.minusEquals,
        "*=": ts.TokenType.asteriskEquals,
        "**=": ts.TokenType.asteriskAsteriskEquals,
        "/=": ts.TokenType.slashEquals,
        "%=": ts.TokenType.percentEquals,
        "<<=": ts.TokenType.lessThanLessThanEquals,
        ">>=": ts.TokenType.greaterThanGreaterThanEquals,
        ">>>=": ts.TokenType.greaterThanGreaterThanGreaterThanEquals,
        "&=": ts.TokenType.ampersandEquals,
        "|=": ts.TokenType.barEquals,
        "^=": ts.TokenType.caretEquals,
        "@": ts.TokenType.at,
    };
    ...
    function createScanner(languageVersion, skipTrivia, languageVariant, text, onError, start, length) {
            ...
            while (true) {
                ...
                switch (ch) {
                    ...
                    case ts.CharCode.exclamation:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            if (text.charCodeAt(pos + 2) === ts.CharCode.equals) {
                                return pos += 3, token = ts.TokenType.exclamationEqualsEquals;
                            }
                            return pos += 2, token = ts.TokenType.exclamationEquals;
                        }
                        pos++;
                        return token = ts.TokenType.exclamation;
                    case ts.CharCode.doubleQuote:
                    case ts.CharCode.singleQuote:
                    ...
                    case ts.CharCode.percent:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.percentEquals;
                        }
                        pos++;
                        return token = ts.TokenType.percent;
                    case ts.CharCode.ampersand:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.ampersand) {
                            return pos += 2, token = ts.TokenType.ampersandAmpersand;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.ampersandEquals;
                        }
                        pos++;
                        return token = ts.TokenType.ampersand;
                    case ts.CharCode.openParen:
                        pos++;
                        return token = ts.TokenType.openParen;
                    case ts.CharCode.closeParen:
                        pos++;
                        return token = ts.TokenType.closeParen;
                    case ts.CharCode.asterisk:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.asteriskEquals;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.asterisk) {
                            if (text.charCodeAt(pos + 2) === ts.CharCode.equals) {
                                return pos += 3, token = ts.TokenType.asteriskAsteriskEquals;
                            }
                            return pos += 2, token = ts.TokenType.asteriskAsterisk;
                        }
                        pos++;
                        return token = ts.TokenType.asterisk;
                    case ts.CharCode.plus:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.plus) {
                            return pos += 2, token = ts.TokenType.plusPlus;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.plusEquals;
                        }
                        pos++;
                        return token = ts.TokenType.plus;
                    case ts.CharCode.comma:
                        pos++;
                        return token = ts.TokenType.comma;
                    case ts.CharCode.minus:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.minus) {
                            return pos += 2, token = ts.TokenType.minusMinus;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.minusEquals;
                        }
                        pos++;
                        return token = ts.TokenType.minus;
                    case ts.CharCode.dot:
                        ...
                        if (text.charCodeAt(pos + 1) === ts.CharCode.dot && text.charCodeAt(pos + 2) === ts.CharCode.dot) {
                            return pos += 3, token = ts.TokenType.dotDotDot;
                        }
                        pos++;
                        return token = ts.TokenType.dot;
                    case ts.CharCode.slash:
                        // Single-line comment
                        if (text.charCodeAt(pos + 1) === ts.CharCode.slash) {
                            pos += 2;
                        ...
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.slashEquals;
                        }
                        pos++;
                        return token = ts.TokenType.slash;
                    case ts.CharCode.num0:
                    ...
                    case ts.CharCode.colon:
                        pos++;
                        return token = ts.TokenType.colon;
                    case ts.CharCode.semicolon:
                        pos++;
                        return token = ts.TokenType.semicolon;
                    case ts.CharCode.lessThan:
                        if (isConflictMarkerTrivia(text, pos)) {
                        ...
                        if (text.charCodeAt(pos + 1) === ts.CharCode.lessThan) {
                            if (text.charCodeAt(pos + 2) === ts.CharCode.equals) {
                                return pos += 3, token = ts.TokenType.lessThanLessThanEquals;
                            }
                            return pos += 2, token = ts.TokenType.lessThanLessThan;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.lessThanEquals;
                        }
                        ...
                        pos++;
                        return token = ts.TokenType.lessThan;
                    case ts.CharCode.equals:
                        if (isConflictMarkerTrivia(text, pos)) {
                            pos = scanConflictMarkerTrivia(text, pos, error);
                            if (skipTrivia) {
                        ...
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            if (text.charCodeAt(pos + 2) === ts.CharCode.equals) {
                                return pos += 3, token = ts.TokenType.equalsEqualsEquals;
                            }
                            return pos += 2, token = ts.TokenType.equalsEquals;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.greaterThan) {
                            return pos += 2, token = ts.TokenType.equalsGreaterThan;
                        }
                        pos++;
                        return token = ts.TokenType.equals;
                    case ts.CharCode.greaterThan:
                        if (isConflictMarkerTrivia(text, pos)) {
                            pos = scanConflictMarkerTrivia(text, pos, error);
                            if (skipTrivia) {
                        ...
                        pos++;
                        return token = ts.TokenType.greaterThan;
                    case ts.CharCode.question:
                        pos++;
                        return token = ts.TokenType.question;
                    case ts.CharCode.openBracket:
                        pos++;
                        return token = ts.TokenType.openBracket;
                    case ts.CharCode.closeBracket:
                        pos++;
                        return token = ts.TokenType.closeBracket;
                    case ts.CharCode.caret:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.caretEquals;
                        }
                        pos++;
                        return token = ts.TokenType.caret;
                    case ts.CharCode.openBrace:
                        pos++;
                        return token = ts.TokenType.openBrace;
                    case ts.CharCode.bar:
                        if (text.charCodeAt(pos + 1) === ts.CharCode.bar) {
                            return pos += 2, token = ts.TokenType.barBar;
                        }
                        if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                            return pos += 2, token = ts.TokenType.barEquals;
                        }
                        pos++;
                        return token = ts.TokenType.bar;
                    case ts.CharCode.closeBrace:
                        pos++;
                        return token = ts.TokenType.closeBrace;
                    case ts.CharCode.tilde:
                        pos++;
                        return token = ts.TokenType.tilde;
                    case ts.CharCode.at:
                        pos++;
                        return token = ts.TokenType.at;
        ...
        function reScanGreaterToken() {
            if (token === ts.TokenType.greaterThan) {
                if (text.charCodeAt(pos) === ts.CharCode.greaterThan) {
                    if (text.charCodeAt(pos + 1) === ts.CharCode.greaterThan) {
                        if (text.charCodeAt(pos + 2) === ts.CharCode.equals) {
                            return pos += 3, token = ts.TokenType.greaterThanGreaterThanGreaterThanEquals;
                        }
                        return pos += 2, token = ts.TokenType.greaterThanGreaterThanGreaterThan;
                    }
                    if (text.charCodeAt(pos + 1) === ts.CharCode.equals) {
                        return pos += 2, token = ts.TokenType.greaterThanGreaterThanEquals;
                    }
                    pos++;
                    return token = ts.TokenType.greaterThanGreaterThan;
                }
                if (text.charCodeAt(pos) === ts.CharCode.equals) {
                    pos++;
                    return token = ts.TokenType.greaterThanEquals;
                }
            }
            return token;
        }
        function reScanSlashToken() {
            if (token === ts.TokenType.slash || token === ts.TokenType.slashEquals) {
                var p = tokenPos + 1;
                var inEscape = false;
        ...
        function reScanTemplateToken() {
            ts.Debug.assert(token === ts.TokenType.closeBrace, "'reScanTemplateToken' should only be called on a '}'");
            pos = tokenPos;
            return token = scanTemplateAndSetTokenValue();
        }
        ...
        function scanJSDocToken() {
            ...
            switch (ch) {
                case ts.CharCode.at:
                    return pos += 1, token = ts.TokenType.at;
                case ts.CharCode.lineFeed:
                case ts.CharCode.carriageReturn:
                    return pos += 1, token = ts.TokenType.newLine;
                case ts.CharCode.asterisk:
                    return pos += 1, token = ts.TokenType.asterisk;
                case ts.CharCode.openBrace:
                    return pos += 1, token = ts.TokenType.openBrace;
                case ts.CharCode.closeBrace:
                    return pos += 1, token = ts.TokenType.closeBrace;
                case ts.CharCode.openBracket:
                    return pos += 1, token = ts.TokenType.openBracket;
                case ts.CharCode.closeBracket:
                    return pos += 1, token = ts.TokenType.closeBracket;
                case ts.CharCode.equals:
                    return pos += 1, token = ts.TokenType.equals;
                case ts.CharCode.comma:
                    return pos += 1, token = ts.TokenType.comma;
            }
