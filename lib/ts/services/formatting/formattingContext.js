    ...
    (function (formatting) {
        var FormattingContext = (function () {
            ...
            FormattingContext.prototype.BlockIsOnOneLine = function (node) {
                var openBrace = ts.findChildOfKind(node, SyntaxKind.OpenBraceToken, this.sourceFile);
                var closeBrace = ts.findChildOfKind(node, SyntaxKind.CloseBraceToken, this.sourceFile);
