...
(function (TokenType) {
     ...
     * 最小的保留字 1。
     */
    TokenType[TokenType["MIN_RESERVERD_WORD_1"] = 4] = "MIN_RESERVERD_WORD_1";
    /**
     ...
     */
    TokenType[TokenType["private"] = 7] = "private";
    /**
     * 关键字 protected(仅在 JavaScript 7)。
     */
    TokenType[TokenType["protected"] = 8] = "protected";
    /**
     * 关键字 public(仅在 JavaScript 7)。
     */
    TokenType[TokenType["public"] = 9] = "public";
    /**
     * 关键字 static(仅在 JavaScript 7)。
     */
    TokenType[TokenType["static"] = 10] = "static";
    /**
     * 关键字 abstract(仅在 JavaScript 7)。
     */
    TokenType[TokenType["abstract"] = 11] = "abstract";
    /**
     * 关键字 declare(仅在 TypeScript)。
     */
    TokenType[TokenType["declare"] = 12] = "declare";
    /**
     * 关键字 readonly(仅在 TypeScript)。
     */
    TokenType[TokenType["readonly"] = 13] = "readonly";
    /**
     * 最大的修饰符前缀。
     */
    TokenType[TokenType["MAX_MODIFIER"] = 14] = "MAX_MODIFIER";
    // #endregion
    // #region 定义(Declarations)
    /**
     * 最小的定义前缀。
     */
    TokenType[TokenType["MIN_DECLARATION"] = 15] = "MIN_DECLARATION";
    /**
     ...
     * 最大的定义前缀。
     */
    TokenType[TokenType["MAX_DECLARATION"] = 21] = "MAX_DECLARATION";
    // #endregion
    // #region 字面量(Literal)
    /**
     * 标识符(x)。
