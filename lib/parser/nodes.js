...
var FunctionTypeNode = (function (_super) {
    ...
    Object.defineProperty(FunctionTypeNode.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
        get: function () { return (this.typeParameters || this.parameters).start; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FunctionTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.returnType.end; },
        enumerable: true,
        configurable: true
    });
    /**
...
var ConstructorTypeNode = (function (_super) {
    ...
    Object.defineProperty(ConstructorTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.returnType.end; },
...
var ArrayBindingPattern = (function (_super) {
    ...
    Object.defineProperty(ArrayBindingPattern.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
    ...
    Object.defineProperty(ArrayBindingPattern.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
...
var ArrayBindingElement = (function (_super) {
    ...
    Object.defineProperty(ArrayBindingElement.prototype, "start", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.dotDotDot != undefined ? this.dotDotDot : this.name ? this.name.start : this.commaToken; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ArrayBindingElement.prototype, "end", {
         ...
         * 获取当前节点的结束位置。
         */
        get: function () { return this.initializer ? this.initializer.end : this.name ? this.name.end : this.commaToken; },
        enumerable: true,
        configurable: true
    });
    /**
...
var ObjectBindingPattern = (function (_super) {
    ...
    Object.defineProperty(ObjectBindingPattern.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
        get: function () { return this.elements.start; },
    ...
    Object.defineProperty(ObjectBindingPattern.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.elements.end; },
 ...
 */
var TypeParameterDeclaration = (function (_super) {
    __extends(TypeParameterDeclaration, _super);
    function TypeParameterDeclaration() {
        _super.apply(this, arguments);
    }
    Object.defineProperty(TypeParameterDeclaration.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
    ...
    Object.defineProperty(TypeParameterDeclaration.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return (this.extends || this.name).end; },
        enumerable: true,
        configurable: true
    });
    /**
     ...
     * @returns 返回访问器的处理结果。
     */
    TypeParameterDeclaration.prototype.accept = function (vistior) {
     ...
     * @returns 如果遍历是因为 *callback* 返回 false 而中止，则返回 false，否则返回 true。
     */
    TypeParameterDeclaration.prototype.each = function (callback, scope) {
...
var Modifier = (function (_super) {
    ...
    Object.defineProperty(Modifier.prototype, "end", {
         ...
         * 获取当前节点的结束位置。
         */
        get: function () { return this.start + tokenToString(this.type).length; },
        enumerable: true,
        configurable: true
    });
    /**
 ...
 */
var PredefinedTypeNode = (function (_super) {
    __extends(PredefinedTypeNode, _super);
    function PredefinedTypeNode() {
        _super.apply(this, arguments);
    }
    Object.defineProperty(PredefinedTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.start + tokenToString(this.type).length; },
     ...
     * @returns 返回访问器的处理结果。
     */
    PredefinedTypeNode.prototype.accept = function (vistior) {
...
var ArrayTypeNode = (function (_super) {
    ...
    Object.defineProperty(ArrayTypeNode.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
    ...
    Object.defineProperty(ArrayTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.closeBracketToken; },
        enumerable: true,
        configurable: true
    });
    /**
...
var TupleTypeNode = (function (_super) {
    ...
    Object.defineProperty(TupleTypeNode.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
        get: function () { return this.elements.start; },
    ...
    Object.defineProperty(TupleTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.elements.end; },
 ...
 */
var BinaryTypeNode = (function (_super) {
    __extends(BinaryTypeNode, _super);
    function BinaryTypeNode() {
        _super.apply(this, arguments);
    }
    Object.defineProperty(BinaryTypeNode.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
    ...
    Object.defineProperty(BinaryTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
     ...
     * @returns 返回访问器的处理结果。
     */
    BinaryTypeNode.prototype.accept = function (vistior) {
        return vistior.visitUnionTypeNode(this);
    };
    return BinaryTypeNode;
}(TypeNode));
exports.BinaryTypeNode = BinaryTypeNode;
/**
 * 表示一个对象类型节点(`{x: string}`)。
 */
...
var ExpressionTypeNode = (function (_super) {
    ...
    Object.defineProperty(ExpressionTypeNode.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
        get: function () { return this.elements.start; },
    ...
    Object.defineProperty(ExpressionTypeNode.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.elements.end; },
...
var NewExpression = (function (_super) {
    ...
    Object.defineProperty(NewExpression.prototype, "end", {
         ...
         * 获取当前节点的开始位置。
         */
        get: function () { return (this.arguments || this.target).end; },
        enumerable: true,
        configurable: true
    });
    /**
...
var PostfixIncrementExpression = (function (_super) {
    ...
    PostfixIncrementExpression.prototype.accept = function (vistior) {
        return vistior.visitPostfixIncrementExpression(this);
    };
    /**
     * 遍历当前节点的所有直接子节点，并对每一项执行 *callback*。
     * @param callback 对每个子节点执行的回调函数。
...
var TypeAssertionExpression = (function (_super) {
    ...
    TypeAssertionExpression.prototype.accept = function (vistior) {
        return vistior.visitTypeAssertionExpression(this);
    };
    /**
     * 遍历当前节点的所有直接子节点，并对每一项执行 *callback*。
     * @param callback 对每个子节点执行的回调函数。
...
var BlockStatement = (function (_super) {
    ...
    Object.defineProperty(BlockStatement.prototype, "start", {
        /**
         * 获取当前节点的开始位置。
         */
        get: function () { return this.statements.start; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(BlockStatement.prototype, "end", {
        /**
         * 获取当前节点的结束位置。
         */
        get: function () { return this.statements.end; },
        enumerable: true,
        configurable: true
    });
    /**
...
/**
 * 表示一个变量声明语句(`var x`、`let x`、`const x`)。
 */
...
var ArrowFunctionExpression = (function (_super) {
    ...
    ArrowFunctionExpression.prototype.each = function (callback, scope) {
        return (!this.modifiers || this.modifiers.each(callback, scope)) &&
            (!this.typeParameters || this.typeParameters.each(callback, scope)) &&
            (!this.parameters || this.parameters.each(callback, scope)) &&
            (!this.returnType || callback.call(scope, this.returnType, "returnType", this) !== false) &&
            callback.call(scope, this.body, "body", this) !== false;
    };
