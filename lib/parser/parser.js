...
var Parser = (function () {
    ...
    Parser.prototype.parseDelimitedList = function (parseElement, openToken, closeToken, allowEmptyList, continueParse) {
        ...
        if (openToken)
            result.start = this.readToken(openToken);
        if (!allowEmptyList || this.lexer.peek().type !== closeToken && this.lexer.peek().type !== tokenType_1.TokenType.endOfFile) {
            while (true) {
                var element = parseElement.call(this);
                result.push(element);
                switch (this.lexer.peek().type) {
                    case tokenType_1.TokenType.comma:
                        element.commaToken = this.readToken(tokenType_1.TokenType.comma);
                        continue;
                    case closeToken:
                    case tokenType_1.TokenType.endOfFile:
                        break;
                    default:
                        ...
                        if (continueParse && continueParse.call(this, this.lexer.peek().type)) {
                            this.readToken(tokenType_1.TokenType.comma);
                            continue;
                        }
                        break;
                }
    ...
    Parser.prototype.parseTypeNode = function () {
        ...
        switch (this.lexer.peek().type) {
            case tokenType_1.TokenType.openParen:
                ...
                if (parameters) {
                    return this.parseFunctionOrConstructorTypeNode(tokenType_1.TokenType.function, parameters);
                }
                break;
            case tokenType_1.TokenType.lessThan:
                return this.parseFunctionOrConstructorTypeNode(tokenType_1.TokenType.function);
            case tokenType_1.TokenType.new:
                return this.parseFunctionOrConstructorTypeNode(tokenType_1.TokenType.new);
        }
        return this.parseUnionOrIntersectionTypeOrHigher(tokenType_1.TokenType.bar);
        // todo: 防止用户输入表达式。
    };
    /**
     * 尝试解析一个参数定义列表。
    ...
    Parser.prototype.tryParseParameterDeclarationList = function () {
        ...
        return this.tryParse(function () {
            ...
            if (_this.lexer.peek().type === tokenType_1.TokenType.equalsGreaterThan || _this.lexer.peek().type === tokenType_1.TokenType.colon) {
                return parameters;
            }
        });
    };
    ...
    Parser.prototype.parseParameterDeclarationList = function () {
        ...
        return this.parseNodeList(this.parseParameterDeclaration, tokenType_1.TokenType.openParen, tokenType_1.TokenType.closeParen, tokenType_1.TokenType.comma, tokenType_1.isBindingNameStart);
    ...
    Parser.prototype.parseParameterDeclaration = function () {
        ...
        result.dotDotDotToken = this.tryReadToken(tokenType_1.TokenType.dotDotDot);
        result.name = this.lexer.peek().type === tokenType_1.TokenType.this ? this.createIdentifier() : this.parseBindingName();
        result.questionToken = this.tryReadToken(tokenType_1.TokenType.question);
    ...
    Parser.prototype.parseDecorator = function () {
        if (this.tryReadToken(tokenType_1.TokenType.comma) == undefined)
            return;
    ...
    Parser.prototype.parseModifier = function (usage) {
        ...
        return this.tryParse(function () {
            ...
            switch (usage) {
                case 0 /* parameter */:
                    if (_this.lexer.peek().type === tokenType_1.TokenType.comma ||
                        _this.lexer.peek().type === tokenType_1.TokenType.colon ||
                        _this.lexer.peek().type === tokenType_1.TokenType.closeParen) {
                        return;
                    }
                case 1 /* property */:
                    if (_this.lexer.peek().type === tokenType_1.TokenType.comma ||
                        _this.lexer.peek().type === tokenType_1.TokenType.colon ||
                        _this.lexer.peek().type === tokenType_1.TokenType.semicolon ||
                        _this.lexer.peek().type === tokenType_1.TokenType.closeBrace) {
                        return;
                    }
                case 2 /* declaration */:
    ...
    Parser.prototype.parseArrayBindingPattern = function () {
        ...
        result.elements = this.parseNodeList(this.parseArrayBindingElement, tokenType_1.TokenType.openBracket, tokenType_1.TokenType.closeBracket, tokenType_1.TokenType.comma, tokenType_1.isBindingNameStart);
        return result;
    };
    /**
     * 解析一个数组绑定模式项(`x`)
    ...
    Parser.prototype.parseObjectBindingPattern = function () {
        ...
        result.elements = this.parseNodeList(this.parseObjectBindingElement, tokenType_1.TokenType.openBrace, tokenType_1.TokenType.closeBrace, tokenType_1.TokenType.comma, tokenType_1.isBindingNameStart);
        return result;
    };
    /**
     * 解析一个对象绑定模式项(`x: y`)
    ...
    Parser.prototype.parseObjectBindingElement = function () {
        ...
        if ((result.colonToken = this.tryReadToken(tokenType_1.TokenType.colon)) != undefined) {
            result.name = this.parseBindingName();
        }
        else if (this.lexer.peek().type !== tokenType_1.TokenType.comma && this.lexer.peek().type !== tokenType_1.TokenType.closeBrace) {
            this.readToken(tokenType_1.TokenType.colon);
        }
        this.parseInitializer(result);
        return result;
    };
    ...
    Parser.prototype.parseComputedPropertyName = function () {
        ...
        result.start = this.readToken(tokenType_1.TokenType.openBracket);
        result.body = this.allowInAnd(this.parseExpression);
        result.end = this.readToken(tokenType_1.TokenType.closeBracket);
        return result;
    };
    /**
     * 解析一个参数注解(`: number`)。
    ...
    Parser.prototype.parseInitializer = function (result) {
        if ((result.equalToken = this.tryReadToken(tokenType_1.TokenType.equals)) != undefined) {
    ...
    Parser.prototype.parseFunctionOrConstructorTypeNode = function (type, parameters) {
        var result = type === tokenType_1.TokenType.new ? new nodes.ConstructorTypeNode() : new nodes.FunctionTypeNode();
        if (type === tokenType_1.TokenType.new)
            result.start = this.readToken(tokenType_1.TokenType.new);
        this.parseMethodSignature(result, tokenType_1.TokenType.equalsGreaterThan, parameters);
        return result;
    };
    /**
     * 解析方法签名。
    ...
    Parser.prototype.parseMethodSignature = function (result, returnType, parameters) {
        ...
        if (returnType === tokenType_1.TokenType.equalsGreaterThan) {
            result.arrowToken = this.readToken(tokenType_1.TokenType.equalsGreaterThan);
        }
        else if (this.tryReadToken(tokenType_1.TokenType.comma)) {
    ...
    Parser.prototype.parseTypeParameterDeclarationList = function () {
        if (this.lexer.peek().type === tokenType_1.TokenType.lessThan) {
            return this.parseNodeList(this.parseTypeParameterDeclaration, tokenType_1.TokenType.lessThan, tokenType_1.TokenType.greaterThan, tokenType_1.TokenType.comma, tokenType_1.isBindingNameStart);
        }
    };
    /**
    ...
    Parser.prototype.parseTypeParameterDeclaration = function () {
        ...
        if ((result.extendsToken = this.tryReadToken(tokenType_1.TokenType.extends)) != undefined) {
    ...
    Parser.prototype.parseUnionOrIntersectionTypeOrHigher = function (type) {
        var result = type === tokenType_1.TokenType.ampersand ? this.parseArrayTypeNodeOrHigher() : this.parseUnionOrIntersectionTypeOrHigher(tokenType_1.TokenType.ampersand);
        while (this.lexer.peek().type === type) {
            result = this.createBinaryTypeNode(result, type, this.readToken(type), type === tokenType_1.TokenType.ampersand ? this.parseArrayTypeNodeOrHigher() : this.parseUnionOrIntersectionTypeOrHigher(tokenType_1.TokenType.ampersand));
        }
        return result;
    };
    /**
    ...
    Parser.prototype.parseArrayTypeNodeOrHigher = function () {
        ...
        while (!this.lexer.peek().hasLineBreakBeforeStart && this.tryReadToken(tokenType_1.TokenType.openBracket)) {
            var newResult = new nodes.ArrayTypeNode();
            newResult.element = result;
            newResult.openBracketToken = this.lexer.current.start;
            newResult.closeBracketToken = this.readToken(tokenType_1.TokenType.closeBracket);
            result = newResult;
        }
        return result;
    };
    ...
    Parser.prototype.parseCallTypeNodeOrHigher = function () {
        switch (this.lexer.peek().type) {
            ...
            case tokenType_1.TokenType.this: {
                ...
                if (this.lexer.peek().type === tokenType_1.TokenType.is && !this.lexer.peek().hasLineBreakBeforeStart) {
    ...
    Parser.prototype.parsePredicateTypeNodeOrHigher = function (parsed) {
        if (this.lexer.peek().type === tokenType_1.TokenType.is && !this.canParseSemicolon()) {
    ...
    Parser.prototype.parseTypeReference = function () {
        ...
        if (!this.lexer.peek().hasLineBreakBeforeStart && this.lexer.peek().type === tokenType_1.TokenType.lessThan) {
            result.typeArguments = this.parseBracketedList(this.parseTypeNode, tokenType_1.TokenType.lessThan, tokenType_1.TokenType.greaterThan, tokenType_1.TokenType.comma);
        }
        return result;
    };
    ...
    Parser.prototype.parseEntityName = function () {
        ...
        while (this.tryReadToken(tokenType_1.TokenType.dot)) {
    ...
    Parser.prototype.parseTypeQuery = function () {
        ...
        result.start = this.readToken(tokenType_1.TokenType.typeof);
    ...
    Parser.prototype.parseTypeMemberSemicolon = function () {
        ...
        if (this.tryReadToken(tokenType_1.TokenType.comma)) {
            return;
        }
    ...
    Parser.prototype.parseSignatureMember = function (kind) {
        ...
        if (kind === tokenType_1.TokenType.ConstructSignature) {
            this.readToken(tokenType_1.TokenType.new);
        }
        this.parseMethodSignature(tokenType_1.TokenType.colon, /*yieldContext*/ false, /*awaitContext*/ false, /*requireCompleteParameterList*/ false, result);
    ...
    Parser.prototype.parseIndexSignatureDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.parameters = this.parseBracketedList(nodes.ParsingContext.Parameters, this.parseParameterDeclaration, tokenType_1.TokenType.openBracket, tokenType_1.TokenType.closeBracket);
    ...
    Parser.prototype.parsePropertyOrMethodSignature = function (fullStart, modifiers) {
        ...
        var questionToken = this.tryReadTokenToken(tokenType_1.TokenType.question);
        if (this.lexer.peek().type === tokenType_1.TokenType.openParen || this.lexer.peek().type === tokenType_1.TokenType.lessThan) {
            ...
            this.parseMethodSignature(tokenType_1.TokenType.colon, /*yieldContext*/ false, /*awaitContext*/ false, /*requireCompleteParameterList*/ false, method);
            this.parseTypeMemberSemicolon();
    ...
    Parser.prototype.parseObjectTypeMembers = function () {
        var members;
        if (this.readToken(tokenType_1.TokenType.openBrace)) {
            members = this.parseList(nodes.ParsingContext.TypeMembers, this.parseTypeMember);
            this.readToken(tokenType_1.TokenType.closeBrace);
        }
        else {
    ...
    Parser.prototype.parseParenthesizedType = function () {
        ...
        this.readToken(tokenType_1.TokenType.openParen);
        result.type = this.parseTypeNode();
        this.readToken(tokenType_1.TokenType.closeParen);
        return result;
    };
    ...
    Parser.prototype.readIdentifier = function (allowES3Keyword) {
        if (this.lexer.peek().type === tokenType_1.TokenType.identifier || (allowES3Keyword ? tokenType_1.isKeyword(this.lexer.peek().type) : tokenType_1.isReservedWord(this.lexer.peek().type))) {
            return this.parseIdentifier();
        }
    ...
    Parser.prototype.parseExpression = function () {
        ...
        var operatorToken;
        while ((operatorToken = this.tryReadTokenToken(tokenType_1.TokenType.comma))) {
    ...
    Parser.prototype.parseYieldExpression = function () {
        ...
        if (!this.lexer.peek().hasLineBreakBeforeStart &&
            ...
            result.asteriskToken = this.tryReadTokenToken(tokenType_1.TokenType.asterisk);
    ...
    Parser.prototype.parseSimpleArrowFunctionExpression = function (identifier, asyncModifier) {
        ...
        result.equalsGreaterThanToken = this.readTokenToken(tokenType_1.TokenType.equalsGreaterThan, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, "=>");
    ...
    Parser.prototype.tryParseParenthesizedArrowFunctionExpression = function () {
        ...
        arrowFunction.equalsGreaterThanToken = this.readTokenToken(tokenType_1.TokenType.equalsGreaterThan, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, "=>");
    ...
    Parser.prototype.isParenthesizedArrowFunctionExpressionWorker = function () {
        ...
        if (first === tokenType_1.TokenType.openParen) {
            ...
            if (this.lexer.read().type === tokenType_1.TokenType.colon) {
                return nodes.Tristate.True;
            }
    ...
    Parser.prototype.isUnParenthesizedAsyncArrowFunctionWorker = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.async) {
            ...
            if (this.lexer.peek().hasLineBreakBeforeStart || this.lexer.peek().type === tokenType_1.TokenType.equalsGreaterThan) {
                return nodes.Tristate.False;
            }
            // nodes.Check for un-parenthesized nodes.AsyncArrowFunction
            var expr = this.parseBinaryExpressionOrHigher(/*precedence*/ 0);
            if (!this.lexer.peek().hasLineBreakBeforeStart && expr.kind === tokenType_1.TokenType.Identifier && this.lexer.peek().type === tokenType_1.TokenType.equalsGreaterThan) {
                return nodes.Tristate.True;
            }
        }
        return nodes.Tristate.False;
    ...
    Parser.prototype.parseParenthesizedArrowFunctionExpressionHead = function (allowAmbiguity) {
        ...
        // close paren.
        this.parseMethodSignature(tokenType_1.TokenType.colon, /*yieldContext*/ false, /*awaitContext*/ isAsync, /*requireCompleteParameterList*/ !allowAmbiguity, result);
    ...
    Parser.prototype.parseConditionalExpressionRest = function (leftOperand) {
        ...
        result.colonToken = this.readTokenToken(tokenType_1.TokenType.colon, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, tokenToString(tokenType_1.TokenType.colon));
    ...
    Parser.prototype.parseBinaryExpressionRest = function (precedence, leftOperand) {
        while (true) {
            ...
            if (this.lexer.peek().type === tokenType_1.TokenType.in && this.inallowInContext()) {
                break;
            }
    ...
    Parser.prototype.isBinaryOperator = function () {
        if (this.inallowInContext() && this.lexer.peek().type === tokenType_1.TokenType.in) {
            return false;
        }
    ...
    Parser.prototype.parseIncrementExpression = function () {
        ...
        if ((this.lexer.peek().type === tokenType_1.TokenType.plusPlus || this.lexer.peek().type === tokenType_1.TokenType.minusMinus) && !this.lexer.peek().hasLineBreakBeforeStart) {
    ...
    Parser.prototype.parseSuperExpression = function () {
        ...
        this.readTokenToken(tokenType_1.TokenType.dot, /*reportAtCurrentPosition*/ false, nodes.Diagnostics.super_must_be_followed_by_an_argument_list_or_member_access);
    ...
    Parser.prototype.parseJsxOpeningOrSelfClosingElement = function (inExpressionContext) {
        ...
        this.readToken(tokenType_1.TokenType.lessThan);
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.greaterThan) {
            ...
            this.readToken(tokenType_1.TokenType.slash);
            if (inExpressionContext) {
                this.readToken(tokenType_1.TokenType.greaterThan);
            }
            else {
                this.readToken(tokenType_1.TokenType.greaterThan, /*diagnostic*/ undefined, /*shouldAdvance*/ false);
                this.scanJsxText();
            }
    ...
    Parser.prototype.parseJsxExpression = function (inExpressionContext) {
        ...
        this.readToken(tokenType_1.TokenType.openBrace);
        ...
        if (inExpressionContext) {
            ...
            this.readToken(tokenType_1.TokenType.closeBrace, /*message*/ undefined, /*shouldAdvance*/ false);
            this.scanJsxText();
        }
        return result;
    };
    Parser.prototype.parseJsxAttribute = function () {
        ...
        if (this.tryReadToken(tokenType_1.TokenType.equals)) {
            switch (this.lexer.peek().type) {
                case tokenType_1.TokenType.StringLiteral:
    ...
    Parser.prototype.parseJsxSpreadAttribute = function () {
        ...
        this.readToken(tokenType_1.TokenType.openBrace);
        this.readToken(tokenType_1.TokenType.dotDotDot);
    ...
    Parser.prototype.parseMemberExpressionRest = function (expression) {
        while (true) {
            var dotToken = this.tryReadTokenToken(tokenType_1.TokenType.dot);
            if (dotToken) {
                var propertyAccess = new nodes.PropertyAccessExpression();
                propertyAccess.expression = expression;
                propertyAccess.name = this.parseRightSideOfDot(/*allowIdentifierNames*/ true);
            ...
            if (this.lexer.peek().type === tokenType_1.TokenType.exclamation && !this.lexer.peek().hasLineBreakBeforeStart) {
                this.lexer.read().type;
            ...
            if (!this.inDecoratorContext() && this.tryReadToken(tokenType_1.TokenType.openBracket)) {
                ...
                this.readToken(tokenType_1.TokenType.closeBracket);
    ...
    Parser.prototype.parseTypeArgumentsInExpression = function () {
        if (!this.tryReadToken(tokenType_1.TokenType.lessThan)) {
            return undefined;
        }
        var typeArguments = this.parseDelimitedList(nodes.ParsingContext.TypeArguments, this.parseTypeNode);
        if (!this.readToken(tokenType_1.TokenType.greaterThan)) {
    ...
    Parser.prototype.parseParenthesizedExpression = function () {
        ...
        result.start = this.lexer.read().start;
        result.body = this.allowInAnd(this.parseExpression);
        result.end = this.readToken(tokenType_1.TokenType.closeParen);
        return result;
    };
    ...
    Parser.prototype.parseArrayLiteralExpression = function () {
        ...
        this.readToken(tokenType_1.TokenType.openBracket);
        if (this.lexer.peek().hasLineBreakBeforeStart) {
    ...
    Parser.prototype.parseObjectLiteralElement = function () {
        ...
        var asteriskToken = this.tryReadTokenToken(tokenType_1.TokenType.asterisk);
        ...
        if (isShorthandPropertyAssignment) {
            ...
            var equalsToken = this.tryReadTokenToken(tokenType_1.TokenType.equals);
            if (equalsToken) {
    ...
    Parser.prototype.parseFunctionExpression = function () {
        ...
        this.readToken(tokenType_1.TokenType.function);
        result.asteriskToken = this.tryReadTokenToken(tokenType_1.TokenType.asterisk);
        ...
        this.parseMethodSignature(tokenType_1.TokenType.colon, /*yieldContext*/ isGenerator, /*awaitContext*/ isAsync, /*requireCompleteParameterList*/ false, result);
        ...
        while (true) {
            switch (this.lexer.peek().type) {
                case tokenType_1.TokenType.closeBrace:
                    ...
                    return result;
                case tokenType_1.TokenType.endOfFile:
                    result.statements.end = this.expectToken(tokenType_1.TokenType.closeBrace);
                    return result;
            }
    ...
    Parser.prototype.parseVariableDeclaration = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.equals) {
            ...
            result.equalToken = this.expectToken(tokenType_1.TokenType.equals);
            result.initializer = this.parseExpressionWithoutComma();
        }
        return result;
    };
    ...
    Parser.prototype.parseLabeledOrExpressionStatement = function (parsed) {
        if (parsed.constructor === nodes.Identifier && this.lexer.peek().type === tokenType_1.TokenType.colon) {
    ...
    Parser.prototype.parseSwitchStatement = function () {
        ...
        result.start = this.lexer.read().start;
        if (!this.options.allowMissingSwitchCondition || this.lexer.peek().type !== tokenType_1.TokenType.openBrace) {
            this.parseCondition(result);
        }
        result.cases = new nodes.NodeList();
        result.cases.start = this.readToken(tokenType_1.TokenType.openBrace);
        while (true) {
            switch (this.lexer.peek().type) {
            ...
            if (this.lexer.current.type === tokenType_1.TokenType.case) {
                if (!this.options.allowCaseElse && this.lexer.peek().type === tokenType_1.TokenType.else) {
            ...
            caseCaluse.colonToken = this.readToken(tokenType_1.TokenType.colon);
    ...
    Parser.prototype.parseForStatement = function () {
        ...
        this.allowIn = true;
        var initializer = this.lexer.peek().type === tokenType_1.TokenType.semicolon ? undefined : this.isVariableStatement() ? this.parseVariableStatement() : this.allowInAnd(this.parseExpression);
        ...
        switch (type) {
            case tokenType_1.TokenType.semicolon:
                ...
                result.firstSemicolonToken = this.readToken(tokenType_1.TokenType.semicolon);
                if (this.lexer.peek().type !== tokenType_1.TokenType.semicolon) {
                    result.condition = this.allowInAnd(this.parseExpression);
                }
                result.secondSemicolonToken = this.readToken(tokenType_1.TokenType.semicolon);
        ...
        if (openParan != undefined) {
            ...
            result.closeParanToken = this.readToken(tokenType_1.TokenType.closeParen);
        }
    ...
    Parser.prototype.parseDoWhileStatement = function () {
        ...
        result.body = this.parseEmbeddedStatement();
        result.whileToken = this.readToken(tokenType_1.TokenType.while);
        this.parseCondition(result);
        result.end = this.tryReadSemicolon();
        return result;
    };
    ...
    Parser.prototype.parseBreakStatement = function () {
        ...
        result.start = this.lexer.read().start;
        if (this.lexer.peek().type === tokenType_1.TokenType.identifier || tokenType_1.isReservedWord(this.lexer.peek().type)) {
    ...
    Parser.prototype.parseTryStatement = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.catch) {
            ...
            if (this.lexer.peek().type === tokenType_1.TokenType.openParen) {
                ...
                result.catch.openParanToken = this.readToken(tokenType_1.TokenType.closeParen);
            }
    ...
    Parser.prototype.parseTryClauseBody = function () {
        ...
        var result = new nodes.BlockStatement();
        result.statements = new nodes.NodeList();
        result.statements.start = this.expectToken(tokenType_1.TokenType.openBrace);
    ...
    Parser.prototype.parseEmbeddedStatement = function () {
        ...
        if (result.constructor === nodes.VariableStatement && result.type !== tokenType_1.TokenType.var) {
    ...
    Parser.prototype.nextTokenIsFunctionKeywordOnSameLine = function () {
        this.lexer.read().type;
        return this.lexer.peek().type === tokenType_1.TokenType.function && !this.lexer.peek().hasLineBreakBeforeStart;
    };
    ...
    Parser.prototype.canFollowContextualOfKeyword = function () {
        return this.nextTokenIsIdentifier() && this.lexer.read().type === tokenType_1.TokenType.closeParen;
    };
    ...
    Parser.prototype.parseMethodDeclaration = function (decorators, modifiers, asteriskToken, name, questionToken) {
        ...
        result.name = name;
        result.questionToken = questionToken;
        this.parseMethodSignature(tokenType_1.TokenType.colon, /*yieldContext*/ !!asteriskToken, /*awaitContext*/ !!(result.flags & nodes.NodeFlags.Async), /*requireCompleteParameterList*/ false, result);
    ...
    Parser.prototype.parseClassDeclarationOrExpression = function (fullStart, decorators, modifiers, kind) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        this.readToken(tokenType_1.TokenType.class);
    ...
    Parser.prototype.parseExpressionWithTypeArguments = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.lessThan) {
            result.typeArguments = this.parseBracketedList(nodes.ParsingContext.TypeArguments, this.parseTypeNode, tokenType_1.TokenType.lessThan, tokenType_1.TokenType.greaterThan);
        }
        return result;
    };
    ...
    Parser.prototype.parseInterfaceDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        this.readToken(tokenType_1.TokenType.interface);
        result.name = this.parseIdentifier();
        result.typeParameters = this.parseTypeParameterDeclarations();
    ...
    Parser.prototype.parseTypeAliasDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        this.readToken(tokenType_1.TokenType.type);
        result.name = this.parseIdentifier();
        result.typeParameters = this.parseTypeParameterDeclarations();
        this.readToken(tokenType_1.TokenType.equals);
        result.type = this.parseTypeNode();
        this.tryReadSemicolon();
        return result;
    };
    ...
    Parser.prototype.parseEnumDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        this.readToken(tokenType_1.TokenType.enum);
        result.name = this.parseIdentifier();
        if (this.readToken(tokenType_1.TokenType.openBrace)) {
    ...
    Parser.prototype.parseModuleOrNamespaceDeclaration = function (fullStart, decorators, modifiers, flags) {
        ...
        result.flags |= flags;
        result.name = this.parseIdentifier();
        result.body = this.tryReadToken(tokenType_1.TokenType.dot)
    ...
    Parser.prototype.parseModuleDeclaration = function (fullStart, decorators, modifiers) {
        ...
        else if (this.tryReadToken(tokenType_1.TokenType.namespace)) {
            flags |= nodes.NodeFlags.Namespace;
        }
        else {
            this.readToken(tokenType_1.TokenType.module);
    ...
    Parser.prototype.nextTokenIsOpenParen = function () {
        return this.lexer.read().type === tokenType_1.TokenType.openParen;
    };
    Parser.prototype.nextTokenIsSlash = function () {
        return this.lexer.read().type === tokenType_1.TokenType.slash;
    };
    // #endregion
    // #region 解析导入导出
    Parser.prototype.parseNamespaceExportDeclaration = function (fullStart, decorators, modifiers) {
        ...
        this.readToken(tokenType_1.TokenType.as);
        this.readToken(tokenType_1.TokenType.namespace);
    ...
    Parser.prototype.parseImportDeclarationOrImportEqualsDeclaration = function (fullStart, decorators, modifiers) {
        this.readToken(tokenType_1.TokenType.import);
        ...
        if (identifier ||
            ...
            this.readToken(tokenType_1.TokenType.from);
        }
    ...
    Parser.prototype.parseImportClause = function (identifier, fullStart) {
        ...
        if (!importClause.name ||
            this.tryReadToken(tokenType_1.TokenType.comma)) {
    ...
    Parser.prototype.parseNamespaceImport = function () {
        ...
        this.readToken(tokenType_1.TokenType.asterisk);
        this.readToken(tokenType_1.TokenType.as);
    ...
    Parser.prototype.parseExportDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        if (this.tryReadToken(tokenType_1.TokenType.asterisk)) {
            this.readToken(tokenType_1.TokenType.from);
            ...
            if (this.lexer.peek().type === tokenType_1.TokenType.from || (this.lexer.peek().type === tokenType_1.TokenType.StringLiteral && !this.lexer.peek().hasLineBreakBeforeStart)) {
                this.readToken(tokenType_1.TokenType.from);
                result.moduleSpecifier = this.parseModuleSpecifier();
            }
        }
    ...
    Parser.prototype.parseExportAssignment = function (fullStart, decorators, modifiers) {
        ...
        if (this.tryReadToken(tokenType_1.TokenType.equals)) {
            ...
            this.readToken(tokenType_1.TokenType.default);
        }
        result.expression = this.parseAssignmentExpressionOrHigher();
        this.tryReadSemicolon();
        return result;
    ...
    Parser.prototype.canParseSemicolon = function () {
        ...
        return this.lexer.peek().type === tokenType_1.TokenType.closeBrace || this.lexer.peek().type === tokenType_1.TokenType.endOfFile || this.lexer.peek().hasLineBreakBeforeStart;
    };
    Parser.prototype.parseSemicolon = function () {
        if (this.canParseSemicolon()) {
            ...
            return this.readToken(tokenType_1.TokenType.semicolon);
        }
    };
    ...
    Parser.prototype.isValidHeritageClauseObjectLiteral = function () {
        console.assert(this.lexer.peek().type === tokenType_1.TokenType.openBrace);
        if (this.lexer.read().type === tokenType_1.TokenType.closeBrace) {
    ...
    Parser.prototype.parseTemplateSpan = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.closeBrace) {
            ...
            literal = this.readTokenToken(tokenType_1.TokenType.TemplateTail, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, tokenToString(tokenType_1.TokenType.closeBrace));
        }
