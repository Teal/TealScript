...
var Parser = (function () {
    ...
    Parser.prototype.parseTypeNode = function () {
        ...
        switch (this.lexer.peek().type) {
            case tokenType_1.TokenType.openParen:
                if (this.lookAhead(this.isFunctionTypeStart)) {
     ...
     * 判断是否紧跟函数类型函数。
     */
    Parser.prototype.isFunctionTypeStart = function () {
        this.lexer.read();
        // ( )、 ( ...
        if (this.lexer.peek().type === tokenType_1.TokenType.closeParen || this.lexer.peek().type === tokenType_1.TokenType.dotDotDot) {
            return true;
        }
        while (tokenType_1.isModifier(this.lexer.peek().type)) {
            this.lexer.read();
        }
        if (this.isBindingName()) {
            // ( xxx :、( xxx ,、( xxx ?、( xxx =
     ...
     */
    Parser.prototype.parseFunctionOrConstructorTypeNode = function (type) {
