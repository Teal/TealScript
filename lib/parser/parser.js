...
var Parser = (function () {
    ...
    Parser.prototype.parseForStatement = function () {
        ...
        this.parseExpected(tokenType_1.TokenType.for);
        this.parseExpected(tokenType_1.TokenType.openParen);
        var initializer = undefined;
        if (this.lexer.peek().type !== tokenType_1.TokenType.semicolon) {
            if (this.lexer.peek().type === tokenType_1.TokenType.var || this.lexer.peek().type === tokenType_1.TokenType.let || this.lexer.peek().type === tokenType_1.TokenType.const) {
        ...
        if (this.parseOptional(tokenType_1.TokenType.in)) {
            var forInStatement = new Nodes.ForInStatement();
        ...
        else if (this.parseOptional(tokenType_1.TokenType.of)) {
    ...
    Parser.prototype.parseDoStatement = function () {
        var result = new Nodes.DoStatement();
