...
var Parser = (function () {
    ...
    Parser.prototype.parseParameterDeclarationList = function () {
        ...
        return this.parseNodeList(this.parseParameterDeclaration, 47 /* openParen */, 102 /* closeParen */, 98 /* comma */, tokenType_1.isBindingNameStart);
    ...
    Parser.prototype.parseDecorator = function () {
        if (this.tryReadToken(98 /* comma */) == undefined)
            return;
        ...
        return this.tryParse(function () {
            ...
            switch (usage) {
                ...
                case 1 /* property */:
                    if (_this.lexer.peek().type === 98 /* comma */ ||
                        _this.lexer.peek().type === 105 /* colon */ ||
                        _this.lexer.peek().type === 106 /* semicolon */ ||
    ...
    Parser.prototype.parseArrayBindingPattern = function () {
        ...
        result.elements = this.parseNodeList(this.parseArrayBindingElement, 48 /* openBracket */, 103 /* closeBracket */, 98 /* comma */, tokenType_1.isBindingNameStart);
        return result;
    };
    /**
     * 解析一个数组绑定模式项(`x`)
    ...
    Parser.prototype.parseObjectBindingPattern = function () {
        ...
        result.elements = this.parseNodeList(this.parseObjectBindingElement, 36 /* openBrace */, 104 /* closeBrace */, 98 /* comma */, tokenType_1.isBindingNameStart);
        return result;
    };
    /**
     * 解析一个对象绑定模式项(`x: y`)
    ...
    Parser.prototype.parseObjectBindingElement = function () {
        ...
        if ((result.colonToken = this.tryReadToken(105 /* colon */)) != undefined) {
            result.name = this.parseBindingName();
        }
        else if (this.lexer.peek().type !== 98 /* comma */ && this.lexer.peek().type !== 104 /* closeBrace */) {
    ...
    Parser.prototype.parsePropertyName = function () {
        switch (this.lexer.peek().type) {
            case 24 /* stringLiteral */:
                return this.parseStringLiteral();
            case 23 /* numericLiteral */:
    ...
    Parser.prototype.parseComputedPropertyName = function () {
        ...
        result.start = this.readToken(48 /* openBracket */);
        result.body = this.allowInAnd(this.parseExpression);
        result.end = this.readToken(103 /* closeBracket */);
        return result;
    };
    /**
     * 解析一个参数注解(`: number`)。
    ...
    Parser.prototype.parseInitializer = function (result) {
        if ((result.equalToken = this.tryReadToken(83 /* equals */)) != undefined) {
    ...
    Parser.prototype.parseFunctionOrConstructorTypeNode = function (type, parameters) {
        ...
        this.parseMethodSignature(result, 55 /* equalsGreaterThan */, parameters);
        return result;
    };
    /**
     * 解析方法签名。
    ...
    Parser.prototype.parseMethodSignature = function (result, returnType, parameters) {
        ...
        if (returnType === 55 /* equalsGreaterThan */) {
    ...
    Parser.prototype.parseTypeParameterDeclarationList = function () {
        if (this.lexer.peek().type === 54 /* lessThan */) {
            return this.parseNodeList(this.parseTypeParameterDeclaration, 54 /* lessThan */, 67 /* greaterThan */, 98 /* comma */, tokenType_1.isBindingNameStart);
        }
    };
    /**
    ...
    Parser.prototype.parseTypeParameterDeclaration = function () {
        ...
        if ((result.extendsToken = this.tryReadToken(140 /* extends */)) != undefined) {
    ...
    Parser.prototype.parseUnionOrIntersectionTypeOrHigher = function (type) {
        var result = type === 63 /* ampersand */ ? this.parseArrayTypeNodeOrHigher() : this.parseUnionOrIntersectionTypeOrHigher(63 /* ampersand */);
        while (this.lexer.peek().type === type) {
            ...
            newResult.rightOperand = type === 63 /* ampersand */ ? this.parseArrayTypeNodeOrHigher() : this.parseUnionOrIntersectionTypeOrHigher(63 /* ampersand */);
            result = newResult;
        }
        return result;
    };
    ...
    Parser.prototype.parseArrayTypeNodeOrHigher = function () {
        ...
        while (!this.lexer.peek().hasLineBreakBeforeStart && this.tryReadToken(48 /* openBracket */)) {
            ...
            newResult.closeBracketToken = this.readToken(103 /* closeBracket */);
            result = newResult;
        }
        return result;
    };
     ...
     * @param type 解析的类型。合法的值有：|、&。
     */
    Parser.prototype.parseCallTypeNodeOrHigher = function (x) {
        switch (this.lexer.peek().type) {
            case 24 /* stringLiteral */:
            case 23 /* numericLiteral */:
            case 30 /* true */:
    ...
    Parser.prototype.parsePredicateTypeNodeOrHigher = function (parsed) {
        if (this.lexer.peek().type === 100 /* is */ && !this.canParseSemicolon()) {
            var result = new nodes.PredicateTypeNode();
        }
        return parsed;
    };
    Parser.prototype.createBinaryTypeNode = function (left, type, right) {
    ...
    Parser.prototype.parseTypeReference = function () {
        ...
        if (!this.lexer.peek().hasLineBreakBeforeStart && this.lexer.peek().type === 54 /* lessThan */) {
            result.typeArguments = this.parseBracketedList(this.parseTypeNode, 54 /* lessThan */, 67 /* greaterThan */, 98 /* comma */);
        }
        return result;
    };
