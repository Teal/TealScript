...
var Parser = (function () {
    ...
    Parser.prototype.parseMethodDeclaration = function (decorators, modifiers, asteriskToken, name, questionToken) {
        ...
        this.fillSignature(tokenType_1.TokenType.colon, /*yieldContext*/ !!asteriskToken, /*awaitContext*/ !!(result.flags & nodes.NodeFlags.Async), /*requireCompleteParameterList*/ false, result);
    ...
    Parser.prototype.parseConditionalExpressionRest = function (leftOperand) {
        ...
        result.colonToken = this.parseExpectedToken(tokenType_1.TokenType.colon, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, tokenType_1.tokenToString(tokenType_1.TokenType.colon));
    ...
    Parser.prototype.parseExpected = function (kind, diagnosticMessage, shouldAdvance) {
        ...
        if (diagnosticMessage) {
            ...
            this.parseErrorAtCurrentToken(nodes.Diagnostics._0_expected, tokenType_1.tokenToString(kind));
        }
        return false;
    };
    ...
    Parser.prototype.parseTemplateSpan = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.closeBrace) {
            ...
            literal = this.parseExpectedToken(tokenType_1.TokenType.TemplateTail, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, tokenType_1.tokenToString(tokenType_1.TokenType.closeBrace));
        }
