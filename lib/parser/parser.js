...
var Parser = (function () {
    ...
    Parser.prototype.readToken = function (token) {
        ...
        this.error(this.lexer.peek(), "'{0}' expected; Unexpected token '{1}'.", tokenType_1.getTokenName(token), tokenType_1.getTokenName(this.lexer.peek().type));
    ...
    Parser.prototype.parseDelimitedList = function (parseElement, openToken, closeToken, allowEmptyList, continueParse) {
        ...
        if (openToken)
            result.start = this.readToken(openToken);
        if (!allowEmptyList || this.lexer.peek().type !== closeToken && this.lexer.peek().type !== 1 /* endOfFile */) {
            while (true) {
                var element = parseElement.call(this);
                result.push(element);
                switch (this.lexer.peek().type) {
                    case 109 /* comma */:
                        element.commaToken = this.readToken(109 /* comma */);
                        continue;
                    case closeToken:
                    case 1 /* endOfFile */:
                        break;
    ...
    Parser.prototype.parseTypeNode = function () {
        ...
        switch (this.lexer.peek().type) {
            case 61 /* openParen */:
                ...
                if (parameters) {
                    return this.parseFunctionOrConstructorTypeNode(39 /* function */, parameters);
                }
                break;
            case 68 /* lessThan */:
                return this.parseFunctionOrConstructorTypeNode(39 /* function */);
            case 53 /* new */:
                return this.parseFunctionOrConstructorTypeNode(53 /* new */);
        }
        return this.parseUnionOrIntersectionTypeOrHigher(104 /* bar */);
        // todo: 防止用户输入表达式。
    };
    /**
     * 尝试解析一个参数定义列表。
    ...
    Parser.prototype.tryParseParameterDeclarationList = function () {
        ...
        return this.tryParse(function () {
            ...
            if (_this.lexer.peek().type === 69 /* equalsGreaterThan */ || _this.lexer.peek().type === 5 /* colon */) {
                return parameters;
            }
        });
    };
    ...
    Parser.prototype.parseParameterDeclarationList = function () {
        ...
        return this.parseNodeList(this.parseParameterDeclaration, 61 /* openParen */, 2 /* closeParen */, 109 /* comma */, tokenType_1.isBindingNameStart);
    ...
    Parser.prototype.parseParameterDeclaration = function () {
        ...
        result.dotDotDotToken = this.tryReadToken(57 /* dotDotDot */);
        result.name = this.lexer.peek().type === 21 /* this */ ? this.createIdentifier() : this.parseBindingName();
        result.questionToken = this.tryReadToken(108 /* question */);
    ...
    Parser.prototype.parseDecorator = function () {
        if (this.tryReadToken(109 /* comma */) == undefined)
            return;
    ...
    Parser.prototype.parseModifier = function (usage) {
        ...
        return this.tryParse(function () {
            ...
            switch (usage) {
                case 0 /* parameter */:
                    if (_this.lexer.peek().type === 109 /* comma */ ||
                        _this.lexer.peek().type === 5 /* colon */ ||
                        _this.lexer.peek().type === 2 /* closeParen */) {
                        return;
                    }
                case 1 /* property */:
                    if (_this.lexer.peek().type === 109 /* comma */ ||
                        _this.lexer.peek().type === 5 /* colon */ ||
                        _this.lexer.peek().type === 6 /* semicolon */ ||
                        _this.lexer.peek().type === 4 /* closeBrace */) {
                        return;
                    }
                case 2 /* declaration */:
    ...
    Parser.prototype.parseArrayBindingPattern = function () {
        ...
        result.elements = this.parseNodeList(this.parseArrayBindingElement, 62 /* openBracket */, 3 /* closeBracket */, 109 /* comma */, tokenType_1.isBindingNameStart);
        return result;
    };
    /**
     * 解析一个数组绑定模式项(`x`)
    ...
    Parser.prototype.parseArrayBindingElement = function () {
        ...
        result.dotDotDotToken = this.tryReadToken(57 /* dotDotDot */);
        if (this.lexer.peek().type !== 109 /* comma */) {
    ...
    Parser.prototype.parseObjectBindingPattern = function () {
        ...
        result.elements = this.parseNodeList(this.parseObjectBindingElement, 51 /* openBrace */, 4 /* closeBrace */, 109 /* comma */, tokenType_1.isBindingNameStart);
        return result;
    };
    /**
     * 解析一个对象绑定模式项(`x: y`)
    ...
    Parser.prototype.parseObjectBindingElement = function () {
        ...
        if ((result.colonToken = this.tryReadToken(5 /* colon */)) != undefined) {
            result.name = this.parseBindingName();
        }
        else if (this.lexer.peek().type !== 109 /* comma */ && this.lexer.peek().type !== 4 /* closeBrace */) {
    ...
    Parser.prototype.parseComputedPropertyName = function () {
        ...
        result.start = this.readToken(62 /* openBracket */);
        result.body = this.allowInAnd(this.parseExpression);
        result.end = this.readToken(3 /* closeBracket */);
        return result;
    };
    /**
     * 解析一个参数注解(`: number`)。
    ...
    Parser.prototype.parseInitializer = function (result) {
        if ((result.equalToken = this.tryReadToken(75 /* equals */)) != undefined) {
    ...
    Parser.prototype.parseFunctionOrConstructorTypeNode = function (type, parameters) {
        var result = type === 53 /* new */ ? new nodes.ConstructorTypeNode() : new nodes.FunctionTypeNode();
        if (type === 53 /* new */)
            result.start = this.readToken(53 /* new */);
        this.parseMethodSignature(result, 69 /* equalsGreaterThan */, parameters);
        return result;
    };
    /**
     * 解析方法签名。
    ...
    Parser.prototype.parseMethodSignature = function (result, returnType, parameters) {
        ...
        if (returnType === 69 /* equalsGreaterThan */) {
            result.arrowToken = this.readToken(69 /* equalsGreaterThan */);
        }
        else if (this.tryReadToken(109 /* comma */)) {
    ...
    Parser.prototype.parseTypeParameterDeclarationList = function () {
        if (this.lexer.peek().type === 68 /* lessThan */) {
            return this.parseNodeList(this.parseTypeParameterDeclaration, 68 /* lessThan */, 94 /* greaterThan */, 109 /* comma */, tokenType_1.isBindingNameStart);
        }
    };
    /**
    ...
    Parser.prototype.parseTypeParameterDeclaration = function () {
        ...
        if ((result.extendsToken = this.tryReadToken(145 /* extends */)) != undefined) {
    ...
    Parser.prototype.parseUnionOrIntersectionTypeOrHigher = function (type) {
        var result = type === 92 /* ampersand */ ? this.parseArrayTypeNodeOrHigher() : this.parseUnionOrIntersectionTypeOrHigher(92 /* ampersand */);
        while (this.lexer.peek().type === type) {
            result = this.createBinaryTypeNode(result, type, this.readToken(type), type === 92 /* ampersand */ ? this.parseArrayTypeNodeOrHigher() : this.parseUnionOrIntersectionTypeOrHigher(92 /* ampersand */));
        }
        return result;
    };
    /**
    ...
    Parser.prototype.parseArrayTypeNodeOrHigher = function () {
        ...
        while (!this.lexer.peek().hasLineBreakBeforeStart && this.tryReadToken(62 /* openBracket */)) {
            var newResult = new nodes.ArrayTypeNode();
            newResult.element = result;
            newResult.openBracketToken = this.lexer.current.start;
            newResult.closeBracketToken = this.readToken(3 /* closeBracket */);
            result = newResult;
        }
        return result;
    };
    ...
    Parser.prototype.parseCallTypeNodeOrHigher = function () {
        switch (this.lexer.peek().type) {
            ...
            case 21 /* this */: {
                ...
                if (this.lexer.peek().type === 114 /* is */ && !this.lexer.peek().hasLineBreakBeforeStart) {
    ...
    Parser.prototype.parsePredicateTypeNodeOrHigher = function (parsed) {
        if (this.lexer.peek().type === 114 /* is */ && !this.canParseSemicolon()) {
    ...
    Parser.prototype.parseTypeReference = function () {
        if (tokenType_1.isPredefinedType(this.lexer.peek().type)) {
        ...
        if (!this.lexer.peek().hasLineBreakBeforeStart && this.lexer.peek().type === 68 /* lessThan */) {
            result.typeArguments = this.parseBracketedList(this.parseTypeNode, 68 /* lessThan */, 94 /* greaterThan */, 109 /* comma */);
        }
        return result;
    };
    ...
    Parser.prototype.parseEntityName = function () {
        ...
        while (this.tryReadToken(88 /* dot */)) {
    ...
    Parser.prototype.parseTypeQuery = function () {
        ...
        result.start = this.readToken(55 /* typeof */);
        result.expression = this.parseMemberExpressionOrHigher();
        return result;
    };
    Parser.prototype.isStartOfParameter = function () {
        return this.lexer.peek().type === 57 /* dotDotDot */ || this.isIdentifierOrPattern() || isModifierKind(this.lexer.peek().type) || this.lexer.peek().type === 58 /* at */ || this.lexer.peek().type === 21 /* this */;
    };
    ...
    Parser.prototype.parseTypeMemberSemicolon = function () {
        ...
        if (this.tryReadToken(109 /* comma */)) {
            return;
        }
    ...
    Parser.prototype.parseSignatureMember = function (kind) {
        ...
        if (kind === tokenType_1.TokenType.ConstructSignature) {
            this.readToken(53 /* new */);
        }
        this.parseMethodSignature(5 /* colon */, /*yieldContext*/ false, /*awaitContext*/ false, /*requireCompleteParameterList*/ false, result);
        this.parseTypeMemberSemicolon();
        return result;
    };
    Parser.prototype.isIndexSignature = function () {
        if (this.lexer.peek().type !== 62 /* openBracket */) {
            return false;
        }
    ...
    Parser.prototype.isUnambiguouslyIndexSignature = function () {
        ...
        //
        this.lexer.read().type;
        if (this.lexer.peek().type === 57 /* dotDotDot */ || this.lexer.peek().type === 3 /* closeBracket */) {
            return true;
        }
        ...
        if (this.lexer.peek().type === 5 /* colon */ || this.lexer.peek().type === 109 /* comma */) {
            return true;
        }
        // nodes.Question mark could be an indexer with an optional property,
        // or it could be a conditional expression in a computed property.
        if (this.lexer.peek().type !== 108 /* question */) {
            return false;
        }
        // nodes.If any of the following tokens are after the question mark, it cannot
        // be a conditional expression, so treat it as an indexer.
        this.lexer.read().type;
        return this.lexer.peek().type === 5 /* colon */ || this.lexer.peek().type === 109 /* comma */ || this.lexer.peek().type === 3 /* closeBracket */;
    };
    Parser.prototype.parseIndexSignatureDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.parameters = this.parseBracketedList(nodes.ParsingContext.Parameters, this.parseParameterDeclaration, 62 /* openBracket */, 3 /* closeBracket */);
    ...
    Parser.prototype.parsePropertyOrMethodSignature = function (fullStart, modifiers) {
        ...
        var questionToken = this.tryReadTokenToken(108 /* question */);
        if (this.lexer.peek().type === 61 /* openParen */ || this.lexer.peek().type === 68 /* lessThan */) {
            ...
            this.parseMethodSignature(5 /* colon */, /*yieldContext*/ false, /*awaitContext*/ false, /*requireCompleteParameterList*/ false, method);
            this.parseTypeMemberSemicolon();
            ...
            if (this.lexer.peek().type === 75 /* equals */) {
    ...
    Parser.prototype.isTypeMemberStart = function () {
        ...
        if (idToken) {
            return this.lexer.peek().type === 61 /* openParen */ ||
                this.lexer.peek().type === 68 /* lessThan */ ||
                this.lexer.peek().type === 108 /* question */ ||
                this.lexer.peek().type === 5 /* colon */ ||
    ...
    Parser.prototype.parseTypeMember = function () {
        ...
        if (this.lexer.peek().type === 53 /* new */ && this.lookAhead(this.isStartOfConstructSignature)) {
    ...
    Parser.prototype.isStartOfConstructSignature = function () {
        this.lexer.read().type;
        return this.lexer.peek().type === 61 /* openParen */ || this.lexer.peek().type === 68 /* lessThan */;
    };
    ...
    Parser.prototype.parseParenthesizedType = function () {
        ...
        this.readToken(61 /* openParen */);
        result.type = this.parseTypeNode();
        this.readToken(2 /* closeParen */);
        return result;
    };
    Parser.prototype.parseKeywordAndNoDot = function () {
        var result = this.parseTokenNode();
        return this.lexer.peek().type === 88 /* dot */ ? undefined : result;
    };
    ...
    Parser.prototype.isStartOfParenthesizedOrFunctionType = function () {
        this.lexer.read().type;
        return this.lexer.peek().type === 2 /* closeParen */ || this.isStartOfParameter() || this.isStartOfType();
    };
    ...
    Parser.prototype.isIdentifier = function () {
        ...
        if (this.lexer.peek().type === 48 /* yield */ && this.inYieldContext()) {
            return false;
        }
        // nodes.If we have a 'await' keyword, and we're in the [nodes.Await] context, then 'await' is
        // considered a keyword and is not an identifier.
        if (this.lexer.peek().type === 49 /* await */ && this.inAwaitContext()) {
            return false;
        }
    ...
    Parser.prototype.readIdentifier = function (allowES3Keyword) {
        if (this.lexer.peek().type === 10 /* identifier */ || (allowES3Keyword ? tokenType_1.isKeyword(this.lexer.peek().type) : tokenType_1.isReservedWord(this.lexer.peek().type))) {
            return this.parseIdentifier();
        }
        this.expectToken(10 /* identifier */);
    ...
    Parser.prototype.isStartOfExpressionStatement = function () {
        ...
        return this.lexer.peek().type !== 51 /* openBrace */ &&
            this.lexer.peek().type !== 39 /* function */ &&
            this.lexer.peek().type !== 40 /* class */ &&
            this.lexer.peek().type !== 58 /* at */ &&
    ...
    Parser.prototype.parseExpression = function () {
        ...
        var operatorToken;
        while ((operatorToken = this.tryReadTokenToken(109 /* comma */))) {
    ...
    Parser.prototype.parseAssignmentExpressionOrHigher = function () {
        ...
        if (expr.kind === tokenType_1.TokenType.Identifier && this.lexer.peek().type === 69 /* equalsGreaterThan */) {
    ...
    Parser.prototype.isYieldExpression = function () {
        if (this.lexer.peek().type === 48 /* yield */) {
    ...
    Parser.prototype.parseYieldExpression = function () {
        ...
        if (!this.lexer.peek().hasLineBreakBeforeStart &&
            (this.lexer.peek().type === 91 /* asterisk */ || this.isStartOfExpression())) {
            result.asteriskToken = this.tryReadTokenToken(91 /* asterisk */);
    ...
    Parser.prototype.parseSimpleArrowFunctionExpression = function (identifier, asyncModifier) {
        console.assert(this.lexer.peek().type === 69 /* equalsGreaterThan */, "this.parseSimpleArrowFunctionExpression should only have been called if we had a =>");
        var result;
        if (asyncModifier) {
        ...
        result.equalsGreaterThanToken = this.readTokenToken(69 /* equalsGreaterThan */, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, "=>");
    ...
    Parser.prototype.tryParseParenthesizedArrowFunctionExpression = function () {
        ...
        arrowFunction.equalsGreaterThanToken = this.readTokenToken(69 /* equalsGreaterThan */, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, "=>");
        arrowFunction.body = (lastToken === 69 /* equalsGreaterThan */ || lastToken === 51 /* openBrace */)
    ...
    Parser.prototype.isParenthesizedArrowFunctionExpression = function () {
        if (this.lexer.peek().type === 61 /* openParen */ || this.lexer.peek().type === 68 /* lessThan */ || this.lexer.peek().type === 27 /* async */) {
            return this.lookAhead(this.isParenthesizedArrowFunctionExpressionWorker);
        }
        if (this.lexer.peek().type === 69 /* equalsGreaterThan */) {
    ...
    Parser.prototype.isParenthesizedArrowFunctionExpressionWorker = function () {
        var _this = this;
        if (this.lexer.peek().type === 27 /* async */) {
            this.lexer.read().type;
            if (this.lexer.peek().hasLineBreakBeforeStart) {
                return nodes.Tristate.False;
            }
        ...
        if (first === 61 /* openParen */) {
            if (second === 2 /* closeParen */) {
            ...
            if (this.lexer.read().type === 5 /* colon */) {
                return nodes.Tristate.True;
            }
            ...
            console.assert(first === 68 /* lessThan */);
    ...
    Parser.prototype.isUnParenthesizedAsyncArrowFunctionWorker = function () {
        ...
        if (this.lexer.peek().type === 27 /* async */) {
            ...
            if (this.lexer.peek().hasLineBreakBeforeStart || this.lexer.peek().type === 69 /* equalsGreaterThan */) {
                return nodes.Tristate.False;
            }
            // nodes.Check for un-parenthesized nodes.AsyncArrowFunction
            var expr = this.parseBinaryExpressionOrHigher(/*precedence*/ 0);
            if (!this.lexer.peek().hasLineBreakBeforeStart && expr.kind === tokenType_1.TokenType.Identifier && this.lexer.peek().type === 69 /* equalsGreaterThan */) {
                return nodes.Tristate.True;
            }
        }
        return nodes.Tristate.False;
    ...
    Parser.prototype.parseParenthesizedArrowFunctionExpressionHead = function (allowAmbiguity) {
        ...
        // close paren.
        this.parseMethodSignature(5 /* colon */, /*yieldContext*/ false, /*awaitContext*/ isAsync, /*requireCompleteParameterList*/ !allowAmbiguity, result);
        ...
        if (!allowAmbiguity && this.lexer.peek().type !== 69 /* equalsGreaterThan */ && this.lexer.peek().type !== 51 /* openBrace */) {
    ...
    Parser.prototype.parseConditionalExpressionRest = function (leftOperand) {
        ...
        result.colonToken = this.readTokenToken(5 /* colon */, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, tokenToString(5 /* colon */));
    ...
    Parser.prototype.parseBinaryExpressionRest = function (precedence, leftOperand) {
        while (true) {
            ...
            //      a ** b - c
            //             ^this.lexer.peek().type; leftOperand = b. nodes.Return b to the caller as a rightOperand
            var consumeCurrentOperator = this.lexer.peek().type === 74 /* asteriskAsterisk */ ?
                newPrecedence >= precedence :
                newPrecedence > precedence;
            if (!consumeCurrentOperator) {
                break;
            }
            if (this.lexer.peek().type === 110 /* in */ && this.inallowInContext()) {
                break;
            }
            if (this.lexer.peek().type === 113 /* as */) {
    ...
    Parser.prototype.isBinaryOperator = function () {
        if (this.inallowInContext() && this.lexer.peek().type === 110 /* in */) {
            return false;
        }
    ...
    Parser.prototype.isAwaitExpression = function () {
        if (this.lexer.peek().type === 49 /* await */) {
    ...
    Parser.prototype.parseUnaryExpressionOrHigher = function () {
        ...
        if (this.isIncrementExpression()) {
            ...
            return this.lexer.peek().type === 74 /* asteriskAsterisk */ ?
        ...
        if (this.lexer.peek().type === 74 /* asteriskAsterisk */) {
    ...
    Parser.prototype.parseIncrementExpression = function () {
        if (this.lexer.peek().type === 66 /* plusPlus */ || this.lexer.peek().type === 67 /* minusMinus */) {
            var result = new nodes.PrefixUnaryExpression();
            result.operator = this.lexer.peek().type;
            this.lexer.read().type;
        ...
        else if (this.sourceFile.languageVariant === nodes.LanguageVariant.JSX && this.lexer.peek().type === 68 /* lessThan */ && this.lookAhead(this.nextTokenIsIdentifierOrKeyword)) {
        ...
        if ((this.lexer.peek().type === 66 /* plusPlus */ || this.lexer.peek().type === 67 /* minusMinus */) && !this.lexer.peek().hasLineBreakBeforeStart) {
    ...
    Parser.prototype.parseLeftHandSideExpressionOrHigher = function () {
        ...
        var expression = this.lexer.peek().type === 23 /* super */
    ...
    Parser.prototype.parseSuperExpression = function () {
        ...
        if (this.lexer.peek().type === 61 /* openParen */ || this.lexer.peek().type === 88 /* dot */ || this.lexer.peek().type === 62 /* openBracket */) {
            return expression;
        }
        ...
        this.readTokenToken(88 /* dot */, /*reportAtCurrentPosition*/ false, nodes.Diagnostics.super_must_be_followed_by_an_argument_list_or_member_access);
    ...
    Parser.prototype.parseJsxElementOrSelfClosingElement = function (inExpressionContext) {
        ...
        if (inExpressionContext && this.lexer.peek().type === 68 /* lessThan */) {
            ...
            if (invalidElement) {
                ...
                badNode.operatorToken = this.createMissingNode(109 /* comma */, /*reportAtCurrentPosition*/ false, /*diagnosticMessage*/ undefined);
    ...
    Parser.prototype.parseJsxOpeningOrSelfClosingElement = function (inExpressionContext) {
        ...
        var result;
        if (this.lexer.peek().type === 94 /* greaterThan */) {
            ...
            this.readToken(65 /* slash */);
            if (inExpressionContext) {
                this.readToken(94 /* greaterThan */);
            }
            else {
                this.readToken(94 /* greaterThan */, /*diagnostic*/ undefined, /*shouldAdvance*/ false);
                this.scanJsxText();
            }
    ...
    Parser.prototype.parseJsxElementName = function () {
        ...
        var expression = this.lexer.peek().type === 21 /* this */ ?
    ...
    Parser.prototype.parseJsxExpression = function (inExpressionContext) {
        ...
        this.readToken(51 /* openBrace */);
        if (this.lexer.peek().type !== 4 /* closeBrace */) {
            result.expression = this.parseAssignmentExpressionOrHigher();
        }
        if (inExpressionContext) {
            this.readToken(4 /* closeBrace */);
            ...
            this.readToken(4 /* closeBrace */, /*message*/ undefined, /*shouldAdvance*/ false);
            this.scanJsxText();
        }
        return result;
    };
    Parser.prototype.parseJsxAttribute = function () {
        ...
        if (this.tryReadToken(75 /* equals */)) {
            switch (this.lexer.peek().type) {
                case tokenType_1.TokenType.StringLiteral:
    ...
    Parser.prototype.parseMemberExpressionRest = function (expression) {
        while (true) {
            var dotToken = this.tryReadTokenToken(88 /* dot */);
            if (dotToken) {
                var propertyAccess = new nodes.PropertyAccessExpression();
                propertyAccess.expression = expression;
                propertyAccess.name = this.parseRightSideOfDot(/*allowIdentifierNames*/ true);
            ...
            if (this.lexer.peek().type === 52 /* exclamation */ && !this.lexer.peek().hasLineBreakBeforeStart) {
                this.lexer.read().type;
            ...
            if (!this.inDecoratorContext() && this.tryReadToken(62 /* openBracket */)) {
                ...
                if (this.lexer.peek().type !== 3 /* closeBracket */) {
    ...
    Parser.prototype.parseCallExpressionRest = function (expression) {
        while (true) {
            ...
            else if (this.lexer.peek().type === 61 /* openParen */) {
                var callExpr = new nodes.CallExpression();
                callExpr.expression = expression;
                callExpr.arguments = this.parseArgumentList();
                expression = this.finishNode(callExpr);
    ...
    Parser.prototype.canFollowTypeArgumentsInExpression = function () {
        switch (this.lexer.peek().type) {
            ...
            case 88 /* dot */: // foo<x>.
            case 2 /* closeParen */: // foo<x>)
            case 3 /* closeBracket */: // foo<x>]
            case 5 /* colon */: // foo<x>:
            case 6 /* semicolon */: // foo<x>;
            case 108 /* question */: // foo<x>?
            case 97 /* equalsEquals */: // foo<x> ==
            case 99 /* equalsEqualsEquals */: // foo<x> ===
            case 98 /* exclamationEquals */: // foo<x> !=
            case 100 /* exclamationEqualsEquals */: // foo<x> !==
            case 106 /* ampersandAmpersand */: // foo<x> &&
            case 107 /* barBar */: // foo<x> ||
            case 105 /* caret */: // foo<x> ^
            case 92 /* ampersand */: // foo<x> &
            case 104 /* bar */: // foo<x> |
            case 4 /* closeBrace */: // foo<x> }
            case 1 /* endOfFile */:
                ...
                // treat it as such.
                return true;
            case 109 /* comma */: // foo<x>,
            case 51 /* openBrace */: // foo<x> {
    ...
    Parser.prototype.parseParenthesizedExpression = function () {
        console.assert(this.lexer.peek().type === 61 /* openParen */);
        var result = new nodes.ParenthesizedExpression();
        result.start = this.lexer.read().start;
        result.body = this.allowInAnd(this.parseExpression);
        result.end = this.readToken(2 /* closeParen */);
        return result;
    };
    ...
    Parser.prototype.parseArgumentOrArrayLiteralElement = function () {
        return this.lexer.peek().type === 57 /* dotDotDot */ ? this.parseSpreadElement() :
            this.lexer.peek().type === 109 /* comma */ ? new nodes.Expression() :
    ...
    Parser.prototype.parseObjectLiteralElement = function () {
        ...
        var asteriskToken = this.tryReadTokenToken(91 /* asterisk */);
        ...
        var questionToken = this.tryReadTokenToken(108 /* question */);
        if (asteriskToken || this.lexer.peek().type === 61 /* openParen */ || this.lexer.peek().type === 68 /* lessThan */) {
        ...
        var isShorthandPropertyAssignment = tokenIsIdentifier && (this.lexer.peek().type === 109 /* comma */ || this.lexer.peek().type === 4 /* closeBrace */ || this.lexer.peek().type === 75 /* equals */);
        if (isShorthandPropertyAssignment) {
            var shorthandDeclaration = new nodes.ShorthandPropertyAssignment();
            shorthandDeclaration.name = propertyName;
            shorthandDeclaration.questionToken = questionToken;
            var equalsToken = this.tryReadTokenToken(75 /* equals */);
            if (equalsToken) {
    ...
    Parser.prototype.parseFunctionExpression = function () {
        ...
        this.parseMethodSignature(5 /* colon */, /*yieldContext*/ isGenerator, /*awaitContext*/ isAsync, /*requireCompleteParameterList*/ false, result);
    ...
    Parser.prototype.parseBlockStatement = function () {
        console.assert(this.lexer.peek().type === 51 /* openBrace */);
        ...
        while (true) {
            switch (this.lexer.peek().type) {
                case 4 /* closeBrace */:
                    ...
                    return result;
                case 1 /* endOfFile */:
                    result.statements.end = this.expectToken(4 /* closeBrace */);
                    return result;
            }
    ...
    Parser.prototype.parseVariableStatement = function () {
        console.assert(this.lexer.peek().type === 159 /* var */ || this.lexer.peek().type === 160 /* let */ || this.lexer.peek().type === 37 /* const */);
    ...
    Parser.prototype.parseVariableDeclaration = function () {
        ...
        if (this.lexer.peek().type === 75 /* equals */) {
            ...
            result.equalToken = this.expectToken(75 /* equals */);
            result.initializer = this.parseExpressionWithoutComma();
        }
        return result;
    };
    ...
    Parser.prototype.parseEmptyStatement = function () {
        console.assert(this.lexer.peek().type === 6 /* semicolon */);
    ...
    Parser.prototype.parseLabeledOrExpressionStatement = function (parsed) {
        if (parsed.constructor === nodes.Identifier && this.lexer.peek().type === 5 /* colon */) {
    ...
    Parser.prototype.parseLabeledStatement = function (label) {
        console.assert(this.lexer.peek().type === 5 /* colon */);
    ...
    Parser.prototype.parseSwitchStatement = function () {
        console.assert(this.lexer.peek().type == 148 /* switch */);
        var result = new nodes.SwitchStatement();
        result.start = this.lexer.read().start;
        if (!this.options.allowMissingSwitchCondition || this.lexer.peek().type !== 51 /* openBrace */) {
            this.parseCondition(result);
        }
        result.cases = new nodes.NodeList();
        result.cases.start = this.readToken(51 /* openBrace */);
        while (true) {
            switch (this.lexer.peek().type) {
                case 141 /* case */:
                case 142 /* default */:
            ...
            if (this.lexer.current.type === 141 /* case */) {
                if (!this.options.allowCaseElse && this.lexer.peek().type === 140 /* else */) {
            ...
            caseCaluse.colonToken = this.readToken(5 /* colon */);
    ...
    Parser.prototype.parseForStatement = function () {
        console.assert(this.lexer.peek().type == 149 /* for */);
        var start = this.lexer.read().start;
        var openParan = this.lexer.peek().type === 61 /* openParen */ ?
            this.lexer.read().start : undefined;
        if (openParan == undefined && !this.options.allowMissingParenthese) {
            this.expectToken(61 /* openParen */);
        }
        var allowIn = this.allowIn;
        this.allowIn = true;
        var initializer = this.lexer.peek().type === 6 /* semicolon */ ? undefined : this.isVariableStatement() ? this.parseVariableStatement() : this.allowInAnd(this.parseExpression);
            ...
            switch (initializer.constructor) {
                case nodes.VariableStatement:
                    if (!this.options.useCompatibleForInAndForOf) {
                        ...
                        if (type !== 138 /* to */ && variables[0].initializer)
                            this.error(variables[0].initializer, type === 110 /* in */ ? "在 for..in 语句变量不能有初始值。" : "在 for..of 语句变量不能有初始值。");
                        if (variables.length > 1) {
                            this.error(variables[1].name, type === 110 /* in */ ? "在 for..in 语句中只能定义一个变量。" :
                                type === 137 /* of */ ? "在 for..of 语句中只能定义一个变量。" :
                ...
                case nodes.Identifier:
                    break;
                default:
                    this.error(initializer, type === 110 /* in */ ? "在 for..in 语句的左边只能是标识符。" :
                        type === 137 /* of */ ? "在 for..of 语句的左边只能是标识符。" :
        ...
        switch (type) {
            case 6 /* semicolon */:
                ...
                result.firstSemicolonToken = this.readToken(6 /* semicolon */);
                if (this.lexer.peek().type !== 6 /* semicolon */) {
                    result.condition = this.allowInAnd(this.parseExpression);
                }
                result.secondSemicolonToken = this.readToken(6 /* semicolon */);
                if (openParan != undefined ? this.lexer.peek().type !== 2 /* closeParen */ : tokenType_1.isExpressionStart(this.lexer.peek().type)) {
        ...
        if (openParan != undefined) {
            ...
            result.closeParanToken = this.readToken(2 /* closeParen */);
        }
    ...
    Parser.prototype.parseWhileStatement = function () {
        console.assert(this.lexer.peek().type === 150 /* while */);
    ...
    Parser.prototype.parseDoWhileStatement = function () {
        console.assert(this.lexer.peek().type === 151 /* do */);
        var result = new nodes.DoWhileStatement();
        result.start = this.lexer.read().type;
        result.body = this.parseEmbeddedStatement();
        result.whileToken = this.readToken(150 /* while */);
        this.parseCondition(result);
        result.end = this.tryReadSemicolon();
        return result;
    };
    ...
    Parser.prototype.parseBreakStatement = function () {
        console.assert(this.lexer.peek().type === 153 /* break */);
        var result = new nodes.BreakStatement();
        result.start = this.lexer.read().start;
        if (this.lexer.peek().type === 10 /* identifier */ || tokenType_1.isReservedWord(this.lexer.peek().type)) {
    ...
    Parser.prototype.parseContinueStatement = function () {
        console.assert(this.lexer.peek().type === 152 /* continue */);
    ...
    Parser.prototype.parseReturnStatement = function () {
        console.assert(this.lexer.peek().type === 154 /* return */);
    ...
    Parser.prototype.parseThrowStatement = function () {
        console.assert(this.lexer.peek().type === 155 /* throw */);
    ...
    Parser.prototype.parseTryStatement = function () {
        console.assert(this.lexer.peek().type == 156 /* try */);
        var result = new nodes.TryStatement();
        result.start = this.lexer.read().start;
        result.try = this.parseTryClauseBody();
        if (this.lexer.peek().type === 143 /* catch */) {
            ...
            if (this.lexer.peek().type === 61 /* openParen */) {
                ...
                result.catch.openParanToken = this.readToken(2 /* closeParen */);
            }
        ...
        if (this.lexer.peek().type === 144 /* finally */) {
    ...
    Parser.prototype.parseTryClauseBody = function () {
        ...
        var result = new nodes.BlockStatement();
        result.statements = new nodes.NodeList();
        result.statements.start = this.expectToken(51 /* openBrace */);
    ...
    Parser.prototype.parseDebuggerStatement = function () {
        console.assert(this.lexer.peek().type === 157 /* debugger */);
    ...
    Parser.prototype.parseWithStatement = function () {
        console.assert(this.lexer.peek().type === 158 /* with */);
    ...
    Parser.prototype.parseEmbeddedStatement = function () {
        ...
        if (result.constructor === nodes.VariableStatement && result.type !== 159 /* var */) {
    ...
    Parser.prototype.isDeclarationStart = function () {
        ...
        while (true) {
            switch (this.lexer.peek().type) {
                ...
                case tokenType_1.TokenType.global:
                    this.lexer.read().type;
                    return this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === tokenType_1.TokenType.Identifier || this.lexer.peek().type === 36 /* export */;
                case 161 /* import */:
                    this.lexer.read().type;
                    return this.lexer.peek().type === tokenType_1.TokenType.StringLiteral || this.lexer.peek().type === 91 /* asterisk */ ||
                        this.lexer.peek().type === 51 /* openBrace */ || tokenIsIdentifierOrKeyword(this.lexer.peek().type);
                case 36 /* export */:
                    this.lexer.read().type;
                    if (this.lexer.peek().type === 75 /* equals */ || this.lexer.peek().type === 91 /* asterisk */ ||
                        this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === 142 /* default */ ||
                        this.lexer.peek().type === 113 /* as */) {
                        return true;
                    }
                    continue;
                case 29 /* static */:
    ...
    Parser.prototype.nextTokenIsFunctionKeywordOnSameLine = function () {
        this.lexer.read().type;
        return this.lexer.peek().type === 39 /* function */ && !this.lexer.peek().hasLineBreakBeforeStart;
    };
    ...
    Parser.prototype.nextTokenIsIdentifierOrStartOfDestructuring = function () {
        this.lexer.read().type;
        return this.isIdentifier() || this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === 62 /* openBracket */;
    };
    ...
    Parser.prototype.parseFunctionBlockOrSemicolon = function (isGenerator, isAsync, diagnosticMessage) {
        if (this.lexer.peek().type !== 51 /* openBrace */ && this.canParseSemicolon()) {
            this.tryReadSemicolon();
            return;
        }
    ...
    Parser.prototype.isIdentifierOrPattern = function () {
        return this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === 62 /* openBracket */ || this.isIdentifier();
    };
    Parser.prototype.canFollowContextualOfKeyword = function () {
        return this.nextTokenIsIdentifier() && this.lexer.read().type === 2 /* closeParen */;
    };
    ...
    Parser.prototype.parseConstructorDeclaration = function (pos, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        this.readToken(tokenType_1.TokenType.constructor);
        this.parseMethodSignature(5 /* colon */, /*yieldContext*/ false, /*awaitContext*/ false, /*requireCompleteParameterList*/ false, result);
    ...
    Parser.prototype.parseMethodDeclaration = function (decorators, modifiers, asteriskToken, name, questionToken) {
        ...
        result.name = name;
        result.questionToken = questionToken;
        this.parseMethodSignature(5 /* colon */, /*yieldContext*/ !!asteriskToken, /*awaitContext*/ !!(result.flags & nodes.NodeFlags.Async), /*requireCompleteParameterList*/ false, result);
    ...
    Parser.prototype.isClassMemberStart = function () {
        ...
        if (this.lexer.peek().type === 91 /* asterisk */) {
            return true;
        }
        // nodes.Try to get the first property-like this.lexer.peek().type following all modifiers.
        ...
        if (idToken !== undefined) {
            ...
            if (!tokenType_1.isKeyword(idToken) || idToken === tokenType_1.TokenType.set || idToken === tokenType_1.TokenType.get) {
                return true;
            }
            // nodes.If it *is* a keyword, but not an accessor, check a little farther along
            // to see if it should actually be parsed as a class member.
            switch (this.lexer.peek().type) {
                case 61 /* openParen */: // nodes.Method declaration
                case 68 /* lessThan */: // nodes.Generic nodes.Method declaration
                case 5 /* colon */: // nodes.Type nodes.Annotation for declaration
                case 75 /* equals */: // nodes.Initializer for declaration
                case 108 /* question */:
                    return true;
                default:
                    // nodes.Covers
    ...
    Parser.prototype.parseClassElement = function () {
        ...
        if (tokenIsIdentifierOrKeyword(this.lexer.peek().type) ||
            ...
            this.lexer.peek().type === 91 /* asterisk */ ||
            this.lexer.peek().type === 62 /* openBracket */) {
    ...
    Parser.prototype.isImplementsClause = function () {
        return this.lexer.peek().type === 136 /* implements */ && this.lookAhead(this.nextTokenIsIdentifierOrKeyword);
    };
    ...
    Parser.prototype.parseHeritageClause = function () {
        if (this.lexer.peek().type === 145 /* extends */ || this.lexer.peek().type === 136 /* implements */) {
    ...
    Parser.prototype.parseExpressionWithTypeArguments = function () {
        ...
        if (this.lexer.peek().type === 68 /* lessThan */) {
            result.typeArguments = this.parseBracketedList(nodes.ParsingContext.TypeArguments, this.parseTypeNode, 68 /* lessThan */, 94 /* greaterThan */);
        }
        return result;
    };
    Parser.prototype.isHeritageClause = function () {
        return this.lexer.peek().type === 145 /* extends */ || this.lexer.peek().type === 136 /* implements */;
    };
    ...
    Parser.prototype.parseTypeAliasDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        this.readToken(162 /* type */);
        result.name = this.parseIdentifier();
        result.typeParameters = this.parseTypeParameterDeclarations();
        this.readToken(75 /* equals */);
        result.type = this.parseTypeNode();
        this.tryReadSemicolon();
        return result;
    };
    ...
    Parser.prototype.parseModuleOrNamespaceDeclaration = function (fullStart, decorators, modifiers, flags) {
        ...
        result.flags |= flags;
        result.name = this.parseIdentifier();
        result.body = this.tryReadToken(88 /* dot */)
    ...
    Parser.prototype.parseModuleDeclaration = function (fullStart, decorators, modifiers) {
        ...
        else if (this.tryReadToken(43 /* namespace */)) {
            flags |= nodes.NodeFlags.Namespace;
        }
        else {
            this.readToken(44 /* module */);
    ...
    Parser.prototype.nextTokenIsOpenParen = function () {
        return this.lexer.read().type === 61 /* openParen */;
    };
    Parser.prototype.nextTokenIsSlash = function () {
        return this.lexer.read().type === 65 /* slash */;
    };
    // #endregion
    // #region 解析导入导出
    Parser.prototype.parseNamespaceExportDeclaration = function (fullStart, decorators, modifiers) {
        ...
        this.readToken(113 /* as */);
        this.readToken(43 /* namespace */);
        exportDeclaration.name = this.parseIdentifier();
        this.readToken(6 /* semicolon */);
    ...
    Parser.prototype.parseImportDeclarationOrImportEqualsDeclaration = function (fullStart, decorators, modifiers) {
        this.readToken(161 /* import */);
        var afterImportPos = this.lexer.getStartPos();
        var identifier;
        if (this.isIdentifier()) {
            identifier = this.parseIdentifier();
            if (this.lexer.peek().type !== 109 /* comma */ && this.lexer.peek().type !== 135 /* from */) {
    ...
    Parser.prototype.parseImportClause = function (identifier, fullStart) {
        ...
        if (!importClause.name ||
            this.tryReadToken(109 /* comma */)) {
            importClause.namedBindings = this.lexer.peek().type === 91 /* asterisk */ ? this.parseNamespaceImport() : this.parseNamedImportsOrExports(tokenType_1.TokenType.NamedImports);
        }
    ...
    Parser.prototype.parseNamedImportsOrExports = function (kind) {
        ...
        result.elements = this.parseBracketedList(nodes.ParsingContext.ImportOrExportSpecifiers, kind === tokenType_1.TokenType.NamedImports ? this.parseImportSpecifier : this.parseExportSpecifier, 51 /* openBrace */, 4 /* closeBrace */);
        return result;
    };
    ...
    Parser.prototype.parseExportDeclaration = function (fullStart, decorators, modifiers) {
        ...
        result.decorators = decorators;
        result.modifiers = modifiers;
        if (this.tryReadToken(91 /* asterisk */)) {
            this.readToken(135 /* from */);
            ...
            if (this.lexer.peek().type === 135 /* from */ || (this.lexer.peek().type === tokenType_1.TokenType.StringLiteral && !this.lexer.peek().hasLineBreakBeforeStart)) {
                this.readToken(135 /* from */);
                result.moduleSpecifier = this.parseModuleSpecifier();
            }
        }
    ...
    Parser.prototype.canParseSemicolon = function () {
        ...
        return this.lexer.peek().type === 4 /* closeBrace */ || this.lexer.peek().type === 1 /* endOfFile */ || this.lexer.peek().hasLineBreakBeforeStart;
    };
    Parser.prototype.parseSemicolon = function () {
        if (this.canParseSemicolon()) {
            ...
            return this.readToken(6 /* semicolon */);
        }
    };
    ...
    Parser.prototype.nextTokenIsClassOrFunctionOrAsync = function () {
        this.lexer.read().type;
        return this.lexer.peek().type === 40 /* class */ || this.lexer.peek().type === 39 /* function */ ||
            (this.lexer.peek().type === 27 /* async */ && this.lookAhead(this.nextTokenIsFunctionKeywordOnSameLine));
    };
    ...
    Parser.prototype.isListElement = function (parsingContext, inErrorRecovery) {
        ...
        switch (this.parsingContext) {
            ...
            case nodes.ParsingContext.SwitchClauseStatements:
                ...
                return !(this.lexer.peek().type === 6 /* semicolon */ && inErrorRecovery) && this.isStartOfStatement();
            case nodes.ParsingContext.SwitchClauses:
                return this.lexer.peek().type === 141 /* case */ || this.lexer.peek().type === 142 /* default */;
            ...
            case nodes.ParsingContext.ClassMembers:
                ...
                // for statements.
                return this.lookAhead(this.isClassMemberStart) || (this.lexer.peek().type === 6 /* semicolon */ && !inErrorRecovery);
            case nodes.ParsingContext.EnumMembers:
                ...
                return this.lexer.peek().type === 62 /* openBracket */ || this.isLiteralPropertyName();
            case nodes.ParsingContext.ObjectLiteralMembers:
                return this.lexer.peek().type === 62 /* openBracket */ || this.lexer.peek().type === 91 /* asterisk */ || this.isLiteralPropertyName();
            ...
            case nodes.ParsingContext.ArrayBindingElements:
                return this.lexer.peek().type === 109 /* comma */ || this.lexer.peek().type === 57 /* dotDotDot */ || this.isIdentifierOrPattern();
            ...
            case nodes.ParsingContext.ArrayLiteralMembers:
                return this.lexer.peek().type === 109 /* comma */ || this.lexer.peek().type === 57 /* dotDotDot */ || this.isStartOfExpression();
            ...
            case nodes.ParsingContext.TupleElementTypes:
                return this.lexer.peek().type === 109 /* comma */ || this.isStartOfType();
            ...
            case nodes.ParsingContext.JsxAttributes:
                return tokenIsIdentifierOrKeyword(this.lexer.peek().type) || this.lexer.peek().type === 51 /* openBrace */;
    ...
    Parser.prototype.isValidHeritageClauseObjectLiteral = function () {
        console.assert(this.lexer.peek().type === 51 /* openBrace */);
        if (this.lexer.read().type === 4 /* closeBrace */) {
            ...
            return next === 109 /* comma */ || next === 51 /* openBrace */ || next === 145 /* extends */ || next === 136 /* implements */;
        }
        return true;
    };
    ...
    Parser.prototype.isHeritageClauseExtendsOrImplementsKeyword = function () {
        if (this.lexer.peek().type === 136 /* implements */ ||
            this.lexer.peek().type === 145 /* extends */) {
    ...
    Parser.prototype.isListTerminator = function (kind) {
        ...
        switch (kind) {
            ...
            case nodes.ParsingContext.ObjectBindingElements:
            case nodes.ParsingContext.ImportOrExportSpecifiers:
                return this.lexer.peek().type === 4 /* closeBrace */;
            case nodes.ParsingContext.SwitchClauseStatements:
                return this.lexer.peek().type === 4 /* closeBrace */ || this.lexer.peek().type === 141 /* case */ || this.lexer.peek().type === 142 /* default */;
            case nodes.ParsingContext.HeritageClauseElement:
                return this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === 145 /* extends */ || this.lexer.peek().type === 136 /* implements */;
            case nodes.ParsingContext.VariableDeclarations:
                return this.isVariableDeclaratorListTerminator();
            case nodes.ParsingContext.TypeParameters:
                // nodes.Tokens other than '>' are here for better error recovery
                return this.lexer.peek().type === 94 /* greaterThan */ || this.lexer.peek().type === 61 /* openParen */ || this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === 145 /* extends */ || this.lexer.peek().type === 136 /* implements */;
            case nodes.ParsingContext.ArgumentExpressions:
                // nodes.Tokens other than ')' are here for better error recovery
                return this.lexer.peek().type === 2 /* closeParen */ || this.lexer.peek().type === 6 /* semicolon */;
            case nodes.ParsingContext.ArrayLiteralMembers:
            case nodes.ParsingContext.TupleElementTypes:
            case nodes.ParsingContext.ArrayBindingElements:
                return this.lexer.peek().type === 3 /* closeBracket */;
            case nodes.ParsingContext.Parameters:
                // nodes.Tokens other than ')' and ']' (the latter for index signatures) are here for better error recovery
                return this.lexer.peek().type === 2 /* closeParen */ || this.lexer.peek().type === 3 /* closeBracket */ /*|| this.lexer.peek().type === nodes.SyntaxKind.OpenBraceToken*/;
            case nodes.ParsingContext.TypeArguments:
                // nodes.Tokens other than '>' are here for better error recovery
                return this.lexer.peek().type === 94 /* greaterThan */ || this.lexer.peek().type === 61 /* openParen */;
            case nodes.ParsingContext.HeritageClauses:
                return this.lexer.peek().type === 51 /* openBrace */ || this.lexer.peek().type === 4 /* closeBrace */;
            case nodes.ParsingContext.JsxAttributes:
                return this.lexer.peek().type === 94 /* greaterThan */ || this.lexer.peek().type === 65 /* slash */;
            case nodes.ParsingContext.JsxChildren:
                return this.lexer.peek().type === 68 /* lessThan */ && this.lookAhead(this.nextTokenIsSlash);
            case nodes.ParsingContext.JSDocFunctionParameters:
                return this.lexer.peek().type === 2 /* closeParen */ || this.lexer.peek().type === 5 /* colon */ || this.lexer.peek().type === 4 /* closeBrace */;
            case nodes.ParsingContext.JSDocTypeArguments:
                return this.lexer.peek().type === 94 /* greaterThan */ || this.lexer.peek().type === 4 /* closeBrace */;
            case nodes.ParsingContext.JSDocTupleTypes:
                return this.lexer.peek().type === 3 /* closeBracket */ || this.lexer.peek().type === 4 /* closeBrace */;
            case nodes.ParsingContext.JSDocRecordMembers:
                return this.lexer.peek().type === 4 /* closeBrace */;
        }
    };
    ...
    Parser.prototype.parseTemplateSpan = function () {
        ...
        if (this.lexer.peek().type === 4 /* closeBrace */) {
            ...
            literal = this.readTokenToken(tokenType_1.TokenType.TemplateTail, /*reportAtCurrentPosition*/ false, nodes.Diagnostics._0_expected, tokenToString(4 /* closeBrace */));
        }
