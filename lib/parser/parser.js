...
var Parser = (function () {
    ...
    Parser.prototype.expectSemicolon = function () {
        switch (this.lexer.peek().type) {
            ...
            default:
                ...
                return compiler_1.options.autoInsertSemicolon === false || (compiler_1.options.smartSemicolonInsertion === false && !this.lexer.peek().onNewLine) ?
                    this.expectToken(tokenType_1.TokenType.semicolon).end :
                    this.lexer.current.end;
        }
    };
        ...
        while (true) {
            switch (this.lexer.peek().type) {
                ...
                case tokenType_1.TokenType.closeBracket:
                    ...
                    return result;
                case tokenType_1.TokenType.endOfFile:
                    result.end = this.expectToken(tokenType_1.TokenType.closeBracket);
                    return result;
            }
        ...
        while (true) {
            switch (this.lexer.peek().type) {
                case tokenType_1.TokenType.closeBrace:
                    ...
                    return result;
                case tokenType_1.TokenType.endOfFile:
                    result.end = this.expectToken(tokenType_1.TokenType.closeBrace);
                    return result;
            }
    ...
    Parser.prototype.parseSwitchStatement = function () {
        ...
        result.start = this.lexer.read().start;
        if (compiler_1.options.autoInsertSwitchCondition === false || this.lexer.peek().type !== tokenType_1.TokenType.openBrace) {
            this.parseCondition(result);
        }
        ...
        while (true) {
            ...
            caseCaluse.colon = this.expectToken(tokenType_1.TokenType.colon).start;
    ...
    Parser.prototype.parseForStatement = function () {
        ...
        var openParan = this.lexer.peek().type === tokenType_1.TokenType.openParen ?
            ...
            undefined;
        if (openParan == undefined && compiler_1.options.autoInsertParenthese === false) {
            this.expectToken(tokenType_1.TokenType.openParen);
        }
        ...
        switch (type) {
            case tokenType_1.TokenType.semicolon:
                ...
                result.firstSemicolon = this.expectToken(tokenType_1.TokenType.semicolon).start;
                if (this.lexer.peek().type !== tokenType_1.TokenType.semicolon) {
                    result.condition = this.parseExpression(ParseFlags.allowIn);
                }
                result.secondSemicolon = this.expectToken(tokenType_1.TokenType.semicolon).start;
        ...
        if (openParan != undefined) {
            ...
            result.closeParan = this.expectToken(tokenType_1.TokenType.closeParen).start;
        }
    ...
    Parser.prototype.parseDoWhileStatement = function () {
        ...
        result.body = this.parseEmbeddedStatement();
        result.while = this.expectToken(tokenType_1.TokenType.while).start;
        this.parseCondition(result);
        result.end = this.expectSemicolon();
        return result;
    };
    ...
    Parser.prototype.parseTryStatement = function () {
        ...
        if (this.lexer.peek().type === tokenType_1.TokenType.catch) {
            ...
            if (this.lexer.peek().type === tokenType_1.TokenType.openParen) {
                ...
                result.catch.openParan = this.expectToken(tokenType_1.TokenType.closeParen).start;
            }
    ...
    Parser.prototype.parseMemberCallExpression = function (parsed) {
        ...
        result.dot = this.expectToken(tokenType_1.TokenType.dot).start;
    ...
    Parser.prototype.parseConditionalExpression = function (parsed) {
        ...
        result.colon = this.expectToken(tokenType_1.TokenType.colon).start;
