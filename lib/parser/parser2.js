...
var Parser = (function () {
    ...
    Parser.prototype.parseForStatement = function () {
        ...
        bool;
        hasParentheses = readToken(TokenType.lParam);
...
parseEmbeddedStatement();
{
    ...
    if (result)
        is;
    Semicolon && this.lexer.peek().type == TokenType.lBrace;
    {
...
parseBlock();
{
    // Block :
    //   { StatementList? }
    console.assert(this.lexer.peek().type == TokenType.lBrace);
...
parseYieldStatement();
{
    // YieldStatement :
    //   yield Expression ;
    console.assert(this.lexer.peek().type == TokenType.yield);
    YieldStatement;
...
parseGotoStatement();
{
    // GotoStatement :
    //   goto Identifier ;
    console.assert(this.lexer.peek().type == TokenType.goto);
...
parseWithStatement();
{
    ...
    result.start = this.lexer.read().start;
    bool;
    foundParams = readToken(TokenType.lParam);
