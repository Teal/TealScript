...
var NodeVisitor = (function () {
     ...
     * @param node 要访问的节点。
     */
    NodeVisitor.prototype.visitPostfixIncrementExpression = function (node) {
        node.operand.accept(this);
    };
    /**
     * 访问一个二元运算表达式(`x + y、x = y、...`)。
     ...
     * @param node 要访问的节点。
     */
    NodeVisitor.prototype.visitTypeAssertionExpression = function (node) {
