        ...
        switch (peek) {
            ...
            case '(':
                ...
                function FunctionTypeNode(typeParameters, parameters) {
                    if (typeParameters === void 0) { typeParameters = TypeParameters; }
                    if (parameters === void 0) { parameters = Parameters; }
                    read('=>');
                    _.return = TypeNode;
                }
                break;
        ...
        case 'set':
            ...
            if (isPropertyNameStart(peek)) {
                ...
                function AccessorSignature(getToken, setToken) {
                    if (getToken === void 0) { getToken = read('get'); }
                    if (setToken === void 0) { setToken = read('set'); }
                    doc(_);
                    _.name = PropertyName;
                    readIf('?');
                    _.parameters = Parameters;
    ...
    switch (peek) {
        ...
        case '<':
            ...
            function MethodSignature(name, questionToken) {
                ...
                if (questionToken === void 0) { questionToken = read('?'); }
                doc(_);
                MethodOrConstructOrCallSignature(_);
            }
        default:
...
function Expression(precedence /*允许解析的最低操作符优先级*/, allowIn /*是否解析 in 表达式*/) {
    ...
    switch (peek) {
        ...
        case '(':
            ...
            break;
        case 'numericLiteral':
            result = function NumericLiteral() {
    ...
    function ArrowFunctionExpression(modifiers, typeParameters, parameters /*参数部分*/, allowIn) {
        if (modifiers === void 0) { modifiers = Modifiers; }
        if (typeParameters === void 0) { typeParameters = TypeParameters(); }
        if (parameters === void 0) { parameters = Parameters || Identifier; }
                ...
                switch (peek) {
                    ...
                    case 'in':
                        return function ForInStatement(forToken, openParanToken, initializer) {
                            ...
                            if (openParanToken === void 0) { openParanToken = read('('); }
                            if (initializer === void 0) { initializer = VariableStatement || ExpressionStatement; }
                            read('in');
                    ...
                    default:
                        ...
                        function ForStatement(forToken, openParanToken, initializer) {
                            if (forToken === void 0) { forToken = read('for'); }
                            if (openParanToken === void 0) { openParanToken = read('('); }
                            if (initializer === void 0) { initializer = VariableStatement || ExpressionStatement; }
...
function FunctionDeclaration(decorators, modifiers) {
    if (decorators === void 0) { decorators = Decorators; }
    if (modifiers === void 0) { modifiers = Modifiers; }
...
function ImportAssignmentOrImportDeclaration() {
    ...
    if (peek === '=' && imports.length === 1 && imports[0].constructor === SimpleImportClause && imports[0].name == null) {
